...
use margusk\Warbsorber\Functions\Exceptions\ZipException;
...
{
    Call::invoke('zip_entry_close',ZipException::class,false, $zip_entry);
}
...
{
    return Call::invoke('zip_entry_compressedsize',ZipException::class,false, $zip_entry);
}
...
{
    return Call::invoke('zip_entry_compressionmethod',ZipException::class,false, $zip_entry);
}
...
{
    return Call::invoke('zip_entry_filesize',ZipException::class,false, $zip_entry);
}
...
{
    return Call::invoke('zip_entry_name',ZipException::class,false, $zip_entry);
}
...
{
    Call::invoke('zip_entry_open',ZipException::class,false, $zip_dp, $zip_entry, $mode);
}
...
{
    return Call::invoke('zip_entry_read',ZipException::class,false, $zip_entry, $len);
}
