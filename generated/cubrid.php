...
use margusk\Warbsorber\Functions\Exceptions\CubridException;
...
function cubrid_bind($req_identifier, int $bind_index, $bind_value, string $bind_value_type = null): void
{
    if ($bind_value_type !== null) {
        Call::invoke('cubrid_bind',CubridException::class,false, $req_identifier, $bind_index, $bind_value, $bind_value_type);
    } else {
        Call::invoke('cubrid_bind',CubridException::class,false, $req_identifier, $bind_index, $bind_value);
    }
}
...
{
    return Call::invoke('cubrid_col_size',CubridException::class,false, $conn_identifier, $oid, $attr_name);
}
...
{
    return Call::invoke('cubrid_column_names',CubridException::class,false, $req_identifier);
}
...
{
    return Call::invoke('cubrid_column_types',CubridException::class,false, $req_identifier);
}
...
{
    Call::invoke('cubrid_commit',CubridException::class,false, $conn_identifier);
}
...
{
    if ($new_link !== false) {
        return Call::invoke('cubrid_connect_with_url',CubridException::class,false, $conn_url, $userid, $passwd, $new_link);
    } elseif ($passwd !== null) {
        return Call::invoke('cubrid_connect_with_url',CubridException::class,false, $conn_url, $userid, $passwd);
    } elseif ($userid !== null) {
        return Call::invoke('cubrid_connect_with_url',CubridException::class,false, $conn_url, $userid);
    } else {
        return Call::invoke('cubrid_connect_with_url',CubridException::class,false, $conn_url);
    }
}
...
{
    if ($new_link !== false) {
        return Call::invoke('cubrid_connect',CubridException::class,false, $host, $port, $dbname, $userid, $passwd, $new_link);
    } elseif ($passwd !== null) {
        return Call::invoke('cubrid_connect',CubridException::class,false, $host, $port, $dbname, $userid, $passwd);
    } elseif ($userid !== null) {
        return Call::invoke('cubrid_connect',CubridException::class,false, $host, $port, $dbname, $userid);
    } else {
        return Call::invoke('cubrid_connect',CubridException::class,false, $host, $port, $dbname);
    }
}
...
{
    return Call::invoke('cubrid_current_oid',CubridException::class,false, $req_identifier);
}
...
function cubrid_disconnect($conn_identifier = null): void
{
    if ($conn_identifier !== null) {
        Call::invoke('cubrid_disconnect',CubridException::class,false, $conn_identifier);
    } else {
        Call::invoke('cubrid_disconnect',CubridException::class,false);
    }
}
...
{
    Call::invoke('cubrid_drop',CubridException::class,false, $conn_identifier, $oid);
}
...
{
    Call::invoke('cubrid_free_result',CubridException::class,false, $req_identifier);
}
...
{
    return Call::invoke('cubrid_get_charset',CubridException::class,false, $conn_identifier);
}
...
{
    return Call::invoke('cubrid_get_class_name',CubridException::class,false, $conn_identifier, $oid);
}
...
{
    return Call::invoke('cubrid_get_client_info',CubridException::class,false);
}
...
{
    return Call::invoke('cubrid_get_db_parameter',CubridException::class,false, $conn_identifier);
}
...
{
    return Call::invoke('cubrid_get_query_timeout',CubridException::class,false, $req_identifier);
}
...
{
    return Call::invoke('cubrid_get_server_info',CubridException::class,false, $conn_identifier);
}
...
{
    if ($conn_identifier !== null) {
        return Call::invoke('cubrid_insert_id',CubridException::class,false, $conn_identifier);
    } else {
        return Call::invoke('cubrid_insert_id',CubridException::class,false);
    }
}
...
{
    Call::invoke('cubrid_lob_close',CubridException::class,false, $lob_identifier_array);
}
...
{
    Call::invoke('cubrid_lob_export',CubridException::class,false, $conn_identifier, $lob_identifier, $path_name);
}
...
{
    return Call::invoke('cubrid_lob_get',CubridException::class,false, $conn_identifier, $sql);
}
...
{
    Call::invoke('cubrid_lob_send',CubridException::class,false, $conn_identifier, $lob_identifier);
}
...
{
    return Call::invoke('cubrid_lob_size',CubridException::class,false, $lob_identifier);
}
...
{
    if ($bind_value_type !== null) {
        Call::invoke('cubrid_lob2_bind',CubridException::class,false, $req_identifier, $bind_index, $bind_value, $bind_value_type);
    } else {
        Call::invoke('cubrid_lob2_bind',CubridException::class,false, $req_identifier, $bind_index, $bind_value);
    }
}
...
{
    Call::invoke('cubrid_lob2_close',CubridException::class,false, $lob_identifier);
}
...
{
    Call::invoke('cubrid_lob2_export',CubridException::class,false, $lob_identifier, $file_name);
}
...
{
    Call::invoke('cubrid_lob2_import',CubridException::class,false, $lob_identifier, $file_name);
}
...
{
    if ($type !== "BLOB") {
        return Call::invoke('cubrid_lob2_new',CubridException::class,false, $conn_identifier, $type);
    } elseif ($conn_identifier !== null) {
        return Call::invoke('cubrid_lob2_new',CubridException::class,false, $conn_identifier);
    } else {
        return Call::invoke('cubrid_lob2_new',CubridException::class,false);
    }
}
...
{
    return Call::invoke('cubrid_lob2_read',CubridException::class,null, $lob_identifier, $len);
}
...
{
    Call::invoke('cubrid_lob2_seek',CubridException::class,false, $lob_identifier, $offset, $origin);
}
...
{
    Call::invoke('cubrid_lob2_seek64',CubridException::class,false, $lob_identifier, $offset, $origin);
}
...
{
    return Call::invoke('cubrid_lob2_size',CubridException::class,false, $lob_identifier);
}
...
{
    return Call::invoke('cubrid_lob2_size64',CubridException::class,false, $lob_identifier);
}
...
{
    return Call::invoke('cubrid_lob2_tell',CubridException::class,false, $lob_identifier);
}
...
{
    return Call::invoke('cubrid_lob2_tell64',CubridException::class,false, $lob_identifier);
}
...
{
    Call::invoke('cubrid_lob2_write',CubridException::class,false, $lob_identifier, $buf);
}
...
{
    Call::invoke('cubrid_lock_read',CubridException::class,false, $conn_identifier, $oid);
}
...
{
    Call::invoke('cubrid_lock_write',CubridException::class,false, $conn_identifier, $oid);
}
...
{
    return Call::invoke('cubrid_move_cursor',CubridException::class,false, $req_identifier, $offset, $origin);
}
...
{
    Call::invoke('cubrid_next_result',CubridException::class,false, $result);
}
...
{
    if ($passwd !== null) {
        return Call::invoke('cubrid_pconnect_with_url',CubridException::class,false, $conn_url, $userid, $passwd);
    } elseif ($userid !== null) {
        return Call::invoke('cubrid_pconnect_with_url',CubridException::class,false, $conn_url, $userid);
    } else {
        return Call::invoke('cubrid_pconnect_with_url',CubridException::class,false, $conn_url);
    }
}
...
{
    if ($passwd !== null) {
        return Call::invoke('cubrid_pconnect',CubridException::class,false, $host, $port, $dbname, $userid, $passwd);
    } elseif ($userid !== null) {
        return Call::invoke('cubrid_pconnect',CubridException::class,false, $host, $port, $dbname, $userid);
    } else {
        return Call::invoke('cubrid_pconnect',CubridException::class,false, $host, $port, $dbname);
    }
}
...
{
    return Call::invoke('cubrid_prepare',CubridException::class,false, $conn_identifier, $prepare_stmt, $option);
}
...
{
    if ($value !== null) {
        Call::invoke('cubrid_put',CubridException::class,false, $conn_identifier, $oid, $attr, $value);
    } elseif ($attr !== null) {
        Call::invoke('cubrid_put',CubridException::class,false, $conn_identifier, $oid, $attr);
    } else {
        Call::invoke('cubrid_put',CubridException::class,false, $conn_identifier, $oid);
    }
}
...
{
    Call::invoke('cubrid_rollback',CubridException::class,false, $conn_identifier);
}
...
{
    if ($attr_name !== null) {
        return Call::invoke('cubrid_schema',CubridException::class,false, $conn_identifier, $schema_type, $class_name, $attr_name);
    } elseif ($class_name !== null) {
        return Call::invoke('cubrid_schema',CubridException::class,false, $conn_identifier, $schema_type, $class_name);
    } else {
        return Call::invoke('cubrid_schema',CubridException::class,false, $conn_identifier, $schema_type);
    }
}
...
{
    Call::invoke('cubrid_seq_drop',CubridException::class,false, $conn_identifier, $oid, $attr_name, $index);
}
...
{
    Call::invoke('cubrid_seq_insert',CubridException::class,false, $conn_identifier, $oid, $attr_name, $index, $seq_element);
}
...
{
    Call::invoke('cubrid_seq_put',CubridException::class,false, $conn_identifier, $oid, $attr_name, $index, $seq_element);
}
...
{
    Call::invoke('cubrid_set_add',CubridException::class,false, $conn_identifier, $oid, $attr_name, $set_element);
}
...
{
    Call::invoke('cubrid_set_autocommit',CubridException::class,false, $conn_identifier, $mode);
}
...
{
    Call::invoke('cubrid_set_db_parameter',CubridException::class,false, $conn_identifier, $param_type, $param_value);
}
...
{
    Call::invoke('cubrid_set_drop',CubridException::class,false, $conn_identifier, $oid, $attr_name, $set_element);
}
...
{
    Call::invoke('cubrid_set_query_timeout',CubridException::class,false, $req_identifier, $timeout);
}
