...
use margusk\Warbsorber\Functions\Exceptions\IbmDb2Exception;
...
{
    if ($value !== null) {
        return Call::invoke('db2_autocommit',IbmDb2Exception::class,false, $connection, $value);
    } else {
        return Call::invoke('db2_autocommit',IbmDb2Exception::class,false, $connection);
    }
}
...
{
    if ($scale !== 0) {
        Call::invoke('db2_bind_param',IbmDb2Exception::class,false, $stmt, $parameter_number, $variable_name, $parameter_type, $data_type, $precision, $scale);
    } elseif ($precision !== -1) {
        Call::invoke('db2_bind_param',IbmDb2Exception::class,false, $stmt, $parameter_number, $variable_name, $parameter_type, $data_type, $precision);
    } elseif ($data_type !== 0) {
        Call::invoke('db2_bind_param',IbmDb2Exception::class,false, $stmt, $parameter_number, $variable_name, $parameter_type, $data_type);
    } elseif ($parameter_type !== null) {
        Call::invoke('db2_bind_param',IbmDb2Exception::class,false, $stmt, $parameter_number, $variable_name, $parameter_type);
    } else {
        Call::invoke('db2_bind_param',IbmDb2Exception::class,false, $stmt, $parameter_number, $variable_name);
    }
}
...
{
    return Call::invoke('db2_client_info',IbmDb2Exception::class,false, $connection);
}
...
{
    Call::invoke('db2_close',IbmDb2Exception::class,false, $connection);
}
...
{
    Call::invoke('db2_commit',IbmDb2Exception::class,false, $connection);
}
...
{
    if ($parameters !== null) {
        Call::invoke('db2_execute',IbmDb2Exception::class,false, $stmt, $parameters);
    } else {
        Call::invoke('db2_execute',IbmDb2Exception::class,false, $stmt);
    }
}
...
{
    Call::invoke('db2_free_result',IbmDb2Exception::class,false, $stmt);
}
...
{
    Call::invoke('db2_free_stmt',IbmDb2Exception::class,false, $stmt);
}
...
{
    return Call::invoke('db2_get_option',IbmDb2Exception::class,false, $resource, $option);
}
...
{
    Call::invoke('db2_pclose',IbmDb2Exception::class,false, $resource);
}
...
{
    Call::invoke('db2_rollback',IbmDb2Exception::class,false, $connection);
}
...
{
    return Call::invoke('db2_server_info',IbmDb2Exception::class,false, $connection);
}
...
{
    Call::invoke('db2_set_option',IbmDb2Exception::class,false, $resource, $options, $type);
}
