...
use margusk\Warbsorber\Functions\Exceptions\SemException;
...
{
    return Call::invoke('msg_get_queue',SemException::class,false, $key, $permissions);
}
...
{
    Call::invoke('msg_queue_exists',SemException::class,false, $key);
}
...
{
    Call::invoke('msg_receive',SemException::class,false, $queue, $desired_message_type, $received_message_type, $max_message_size, $message, $unserialize, $flags, $error_code);
}
...
{
    Call::invoke('msg_remove_queue',SemException::class,false, $queue);
}
...
{
    Call::invoke('msg_send',SemException::class,false, $queue, $message_type, $message, $serialize, $blocking, $error_code);
}
...
{
    Call::invoke('msg_set_queue',SemException::class,false, $queue, $data);
}
...
{
    return Call::invoke('msg_stat_queue',SemException::class,false, $queue);
}
...
{
    Call::invoke('sem_acquire',SemException::class,false, $semaphore, $non_blocking);
}
...
{
    return Call::invoke('sem_get',SemException::class,false, $key, $max_acquire, $permissions, $auto_release);
}
...
{
    Call::invoke('sem_release',SemException::class,false, $semaphore);
}
...
{
    Call::invoke('sem_remove',SemException::class,false, $semaphore);
}
...
{
    if ($permissions !== 0666) {
        return Call::invoke('shm_attach',SemException::class,false, $key, $size, $permissions);
    } elseif ($size !== null) {
        return Call::invoke('shm_attach',SemException::class,false, $key, $size);
    } else {
        return Call::invoke('shm_attach',SemException::class,false, $key);
    }
}
...
{
    Call::invoke('shm_detach',SemException::class,false, $shm);
}
...
{
    Call::invoke('shm_put_var',SemException::class,false, $shm, $key, $value);
}
...
{
    Call::invoke('shm_remove_var',SemException::class,false, $shm, $key);
}
...
{
    Call::invoke('shm_remove',SemException::class,false, $shm);
}
