...
use margusk\Warbsorber\Functions\Exceptions\FilterException;
...
{
    return Call::invoke('filter_input_array',FilterException::class,false, $type, $options, $add_empty);
}
...
{
    return Call::invoke('filter_var_array',FilterException::class,false, $array, $options, $add_empty);
}
