...
use margusk\Warbsorber\Functions\Exceptions\ComException;
...
{
    return Call::invoke('com_create_guid',ComException::class,false);
}
...
function com_event_sink(object $variant, object $sink_object, $sink_interface = null): void
{
    if ($sink_interface !== null) {
        Call::invoke('com_event_sink',ComException::class,false, $variant, $sink_object, $sink_interface);
    } else {
        Call::invoke('com_event_sink',ComException::class,false, $variant, $sink_object);
    }
}
...
{
    Call::invoke('com_load_typelib',ComException::class,false, $typelib, $case_insensitive);
}
...
function com_print_typeinfo(object $variant, string $dispatch_interface = null, bool $display_sink = false): void
{
    if ($display_sink !== false) {
        Call::invoke('com_print_typeinfo',ComException::class,false, $variant, $dispatch_interface, $display_sink);
    } elseif ($dispatch_interface !== null) {
        Call::invoke('com_print_typeinfo',ComException::class,false, $variant, $dispatch_interface);
    } else {
        Call::invoke('com_print_typeinfo',ComException::class,false, $variant);
    }
}
...
{
    return Call::invoke('variant_date_to_timestamp',ComException::class,null, $variant);
}
...
{
    return Call::invoke('variant_round',ComException::class,null, $value, $decimals);
}
