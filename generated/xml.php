...
use margusk\Warbsorber\Functions\Exceptions\XmlException;
...
{
    Call::invoke('xml_parser_free',XmlException::class,false, $parser);
}
...
{
    Call::invoke('xml_set_character_data_handler',XmlException::class,false, $parser, $handler);
}
...
{
    Call::invoke('xml_set_default_handler',XmlException::class,false, $parser, $handler);
}
...
{
    Call::invoke('xml_set_element_handler',XmlException::class,false, $parser, $start_handler, $end_handler);
}
...
{
    Call::invoke('xml_set_end_namespace_decl_handler',XmlException::class,false, $parser, $handler);
}
...
{
    Call::invoke('xml_set_external_entity_ref_handler',XmlException::class,false, $parser, $handler);
}
...
{
    Call::invoke('xml_set_notation_decl_handler',XmlException::class,false, $parser, $handler);
}
...
{
    Call::invoke('xml_set_object',XmlException::class,false, $parser, $object);
}
...
{
    Call::invoke('xml_set_processing_instruction_handler',XmlException::class,false, $parser, $handler);
}
...
{
    Call::invoke('xml_set_start_namespace_decl_handler',XmlException::class,false, $parser, $handler);
}
...
{
    Call::invoke('xml_set_unparsed_entity_decl_handler',XmlException::class,false, $parser, $handler);
}
