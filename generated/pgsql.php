...
use margusk\Warbsorber\Functions\Exceptions\PgsqlException;
...
{
    Call::invoke('pg_cancel_query',PgsqlException::class,false, $connection);
}
...
{
    return Call::invoke('pg_connect',PgsqlException::class,false, $connection_string, $flags);
}
...
{
    Call::invoke('pg_connection_reset',PgsqlException::class,false, $connection);
}
...
{
    return Call::invoke('pg_convert',PgsqlException::class,false, $connection, $table_name, $values, $flags);
}
...
{
    Call::invoke('pg_copy_from',PgsqlException::class,false, $connection, $table_name, $rows, $separator, $null_as);
}
...
{
    return Call::invoke('pg_copy_to',PgsqlException::class,false, $connection, $table_name, $separator, $null_as);
}
...
{
    return Call::invoke('pg_delete',PgsqlException::class,false, $connection, $table_name, $conditions, $flags);
}
...
{
    if ($connection !== null) {
        Call::invoke('pg_end_copy',PgsqlException::class,false, $connection);
    } else {
        Call::invoke('pg_end_copy',PgsqlException::class,false);
    }
}
...
{
    if ($params !== null) {
        return Call::invoke('pg_execute',PgsqlException::class,false, $connection, $stmtname, $params);
    } elseif ($stmtname !== null) {
        return Call::invoke('pg_execute',PgsqlException::class,false, $connection, $stmtname);
    } elseif ($connection !== null) {
        return Call::invoke('pg_execute',PgsqlException::class,false, $connection);
    } else {
        return Call::invoke('pg_execute',PgsqlException::class,false);
    }
}
...
{
    return Call::invoke('pg_field_table',PgsqlException::class,false, $result, $field, $oid_only);
}
...
{
    return Call::invoke('pg_flush',PgsqlException::class,false, $connection);
}
...
{
    Call::invoke('pg_free_result',PgsqlException::class,false, $result);
}
...
{
    if ($connection !== null) {
        return Call::invoke('pg_host',PgsqlException::class,'', $connection);
    } else {
        return Call::invoke('pg_host',PgsqlException::class,'');
    }
}
...
{
    return Call::invoke('pg_insert',PgsqlException::class,false, $connection, $table_name, $values, $flags);
}
...
{
    return Call::invoke('pg_last_oid',PgsqlException::class,false, $result);
}
...
{
    Call::invoke('pg_lo_close',PgsqlException::class,false, $lob);
}
...
{
    if ($pathname !== null) {
        Call::invoke('pg_lo_export',PgsqlException::class,false, $connection, $oid, $pathname);
    } elseif ($oid !== null) {
        Call::invoke('pg_lo_export',PgsqlException::class,false, $connection, $oid);
    } elseif ($connection !== null) {
        Call::invoke('pg_lo_export',PgsqlException::class,false, $connection);
    } else {
        Call::invoke('pg_lo_export',PgsqlException::class,false);
    }
}
...
{
    if ($object_id !== null) {
        return Call::invoke('pg_lo_import',PgsqlException::class,false, $connection, $pathname, $object_id);
    } elseif ($pathname !== null) {
        return Call::invoke('pg_lo_import',PgsqlException::class,false, $connection, $pathname);
    } elseif ($connection !== null) {
        return Call::invoke('pg_lo_import',PgsqlException::class,false, $connection);
    } else {
        return Call::invoke('pg_lo_import',PgsqlException::class,false);
    }
}
...
{
    return Call::invoke('pg_lo_open',PgsqlException::class,false, $connection, $oid, $mode);
}
...
{
    return Call::invoke('pg_lo_read',PgsqlException::class,false, $lob, $length);
}
...
{
    Call::invoke('pg_lo_seek',PgsqlException::class,false, $lob, $offset, $whence);
}
...
{
    Call::invoke('pg_lo_truncate',PgsqlException::class,false, $lob, $size);
}
...
{
    Call::invoke('pg_lo_unlink',PgsqlException::class,false, $connection, $oid);
}
...
{
    if ($length !== null) {
        return Call::invoke('pg_lo_write',PgsqlException::class,false, $lob, $data, $length);
    } else {
        return Call::invoke('pg_lo_write',PgsqlException::class,false, $lob, $data);
    }
}
...
{
    return Call::invoke('pg_meta_data',PgsqlException::class,false, $connection, $table_name, $extended);
}
...
{
    if ($param_name !== null) {
        return Call::invoke('pg_parameter_status',PgsqlException::class,false, $connection, $param_name);
    } elseif ($connection !== null) {
        return Call::invoke('pg_parameter_status',PgsqlException::class,false, $connection);
    } else {
        return Call::invoke('pg_parameter_status',PgsqlException::class,false);
    }
}
...
{
    return Call::invoke('pg_pconnect',PgsqlException::class,false, $connection_string, $flags);
}
...
{
    if ($connection !== null) {
        Call::invoke('pg_ping',PgsqlException::class,false, $connection);
    } else {
        Call::invoke('pg_ping',PgsqlException::class,false);
    }
}
...
{
    if ($query !== null) {
        return Call::invoke('pg_prepare',PgsqlException::class,false, $connection, $stmtname, $query);
    } elseif ($stmtname !== null) {
        return Call::invoke('pg_prepare',PgsqlException::class,false, $connection, $stmtname);
    } elseif ($connection !== null) {
        return Call::invoke('pg_prepare',PgsqlException::class,false, $connection);
    } else {
        return Call::invoke('pg_prepare',PgsqlException::class,false);
    }
}
...
{
    if ($data !== null) {
        Call::invoke('pg_put_line',PgsqlException::class,false, $connection, $data);
    } elseif ($connection !== null) {
        Call::invoke('pg_put_line',PgsqlException::class,false, $connection);
    } else {
        Call::invoke('pg_put_line',PgsqlException::class,false);
    }
}
...
{
    if ($params !== null) {
        return Call::invoke('pg_query_params',PgsqlException::class,false, $connection, $query, $params);
    } elseif ($query !== null) {
        return Call::invoke('pg_query_params',PgsqlException::class,false, $connection, $query);
    } elseif ($connection !== null) {
        return Call::invoke('pg_query_params',PgsqlException::class,false, $connection);
    } else {
        return Call::invoke('pg_query_params',PgsqlException::class,false);
    }
}
...
{
    if ($query !== null) {
        return Call::invoke('pg_query',PgsqlException::class,false, $connection, $query);
    } elseif ($connection !== null) {
        return Call::invoke('pg_query',PgsqlException::class,false, $connection);
    } else {
        return Call::invoke('pg_query',PgsqlException::class,false);
    }
}
...
{
    return Call::invoke('pg_result_error_field',PgsqlException::class,false, $result, $field_code);
}
...
{
    Call::invoke('pg_result_seek',PgsqlException::class,false, $result, $row);
}
...
{
    return Call::invoke('pg_select',PgsqlException::class,false, $connection, $table_name, $conditions, $flags, $mode);
}
...
{
    return Call::invoke('pg_socket',PgsqlException::class,false, $connection);
}
...
{
    if ($connection !== null) {
        Call::invoke('pg_trace',PgsqlException::class,false, $filename, $mode, $connection);
    } else {
        Call::invoke('pg_trace',PgsqlException::class,false, $filename, $mode);
    }
}
...
{
    return Call::invoke('pg_update',PgsqlException::class,false, $connection, $table_name, $values, $conditions, $flags);
}
