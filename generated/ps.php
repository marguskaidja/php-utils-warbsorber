...
use margusk\Warbsorber\Functions\Exceptions\PsException;
...
{
    Call::invoke('ps_add_launchlink',PsException::class,false, $psdoc, $llx, $lly, $urx, $ury, $filename);
}
...
{
    Call::invoke('ps_add_locallink',PsException::class,false, $psdoc, $llx, $lly, $urx, $ury, $page, $dest);
}
...
{
    Call::invoke('ps_add_note',PsException::class,false, $psdoc, $llx, $lly, $urx, $ury, $contents, $title, $icon, $open);
}
...
{
    Call::invoke('ps_add_pdflink',PsException::class,false, $psdoc, $llx, $lly, $urx, $ury, $filename, $page, $dest);
}
...
{
    Call::invoke('ps_add_weblink',PsException::class,false, $psdoc, $llx, $lly, $urx, $ury, $url);
}
...
{
    Call::invoke('ps_arc',PsException::class,false, $psdoc, $x, $y, $radius, $alpha, $beta);
}
...
{
    Call::invoke('ps_arcn',PsException::class,false, $psdoc, $x, $y, $radius, $alpha, $beta);
}
...
{
    Call::invoke('ps_begin_page',PsException::class,false, $psdoc, $width, $height);
}
...
{
    return Call::invoke('ps_begin_pattern',PsException::class,false, $psdoc, $width, $height, $xstep, $ystep, $painttype);
}
...
{
    return Call::invoke('ps_begin_template',PsException::class,false, $psdoc, $width, $height);
}
...
{
    Call::invoke('ps_circle',PsException::class,false, $psdoc, $x, $y, $radius);
}
...
{
    Call::invoke('ps_clip',PsException::class,false, $psdoc);
}
...
{
    Call::invoke('ps_close_image',PsException::class,false, $psdoc, $imageid);
}
...
{
    Call::invoke('ps_close',PsException::class,false, $psdoc);
}
...
{
    Call::invoke('ps_closepath_stroke',PsException::class,false, $psdoc);
}
...
{
    Call::invoke('ps_closepath',PsException::class,false, $psdoc);
}
...
{
    Call::invoke('ps_continue_text',PsException::class,false, $psdoc, $text);
}
...
{
    Call::invoke('ps_curveto',PsException::class,false, $psdoc, $x1, $y1, $x2, $y2, $x3, $y3);
}
...
{
    Call::invoke('ps_delete',PsException::class,false, $psdoc);
}
...
{
    Call::invoke('ps_end_page',PsException::class,false, $psdoc);
}
...
{
    Call::invoke('ps_end_pattern',PsException::class,false, $psdoc);
}
...
{
    Call::invoke('ps_end_template',PsException::class,false, $psdoc);
}
...
{
    Call::invoke('ps_fill_stroke',PsException::class,false, $psdoc);
}
...
{
    Call::invoke('ps_fill',PsException::class,false, $psdoc);
}
...
{
    if ($modifier !== null) {
        return Call::invoke('ps_get_parameter',PsException::class,false, $psdoc, $name, $modifier);
    } else {
        return Call::invoke('ps_get_parameter',PsException::class,false, $psdoc, $name);
    }
}
...
{
    return Call::invoke('ps_hyphenate',PsException::class,false, $psdoc, $text);
}
...
{
    Call::invoke('ps_include_file',PsException::class,false, $psdoc, $file);
}
...
{
    Call::invoke('ps_lineto',PsException::class,false, $psdoc, $x, $y);
}
...
{
    Call::invoke('ps_moveto',PsException::class,false, $psdoc, $x, $y);
}
...
function ps_new()
{
    return Call::invoke('ps_new',PsException::class,false);
}
...
{
    if ($filename !== null) {
        Call::invoke('ps_open_file',PsException::class,false, $psdoc, $filename);
    } else {
        Call::invoke('ps_open_file',PsException::class,false, $psdoc);
    }
}
...
{
    Call::invoke('ps_place_image',PsException::class,false, $psdoc, $imageid, $x, $y, $scale);
}
...
{
    Call::invoke('ps_rect',PsException::class,false, $psdoc, $x, $y, $width, $height);
}
...
{
    Call::invoke('ps_restore',PsException::class,false, $psdoc);
}
...
{
    Call::invoke('ps_rotate',PsException::class,false, $psdoc, $rot);
}
...
{
    Call::invoke('ps_save',PsException::class,false, $psdoc);
}
...
{
    Call::invoke('ps_scale',PsException::class,false, $psdoc, $x, $y);
}
...
{
    Call::invoke('ps_set_border_color',PsException::class,false, $psdoc, $red, $green, $blue);
}
...
{
    Call::invoke('ps_set_border_dash',PsException::class,false, $psdoc, $black, $white);
}
...
{
    Call::invoke('ps_set_border_style',PsException::class,false, $psdoc, $style, $width);
}
...
{
    Call::invoke('ps_set_info',PsException::class,false, $p, $key, $val);
}
...
{
    Call::invoke('ps_set_parameter',PsException::class,false, $psdoc, $name, $value);
}
...
{
    Call::invoke('ps_set_text_pos',PsException::class,false, $psdoc, $x, $y);
}
...
{
    Call::invoke('ps_set_value',PsException::class,false, $psdoc, $name, $value);
}
...
{
    Call::invoke('ps_setcolor',PsException::class,false, $psdoc, $type, $colorspace, $c1, $c2, $c3, $c4);
}
...
{
    Call::invoke('ps_setdash',PsException::class,false, $psdoc, $on, $off);
}
...
{
    Call::invoke('ps_setflat',PsException::class,false, $psdoc, $value);
}
...
{
    Call::invoke('ps_setfont',PsException::class,false, $psdoc, $fontid, $size);
}
...
{
    Call::invoke('ps_setgray',PsException::class,false, $psdoc, $gray);
}
...
{
    Call::invoke('ps_setlinecap',PsException::class,false, $psdoc, $type);
}
...
{
    Call::invoke('ps_setlinejoin',PsException::class,false, $psdoc, $type);
}
...
{
    Call::invoke('ps_setlinewidth',PsException::class,false, $psdoc, $width);
}
...
{
    Call::invoke('ps_setmiterlimit',PsException::class,false, $psdoc, $value);
}
...
{
    Call::invoke('ps_setoverprintmode',PsException::class,false, $psdoc, $mode);
}
...
{
    Call::invoke('ps_setpolydash',PsException::class,false, $psdoc, $arr);
}
...
{
    return Call::invoke('ps_shading_pattern',PsException::class,false, $psdoc, $shadingid, $optlist);
}
...
{
    return Call::invoke('ps_shading',PsException::class,false, $psdoc, $type, $x0, $y0, $x1, $y1, $c1, $c2, $c3, $c4, $optlist);
}
...
{
    Call::invoke('ps_shfill',PsException::class,false, $psdoc, $shadingid);
}
...
{
    Call::invoke('ps_show_xy',PsException::class,false, $psdoc, $text, $x, $y);
}
...
{
    Call::invoke('ps_show_xy2',PsException::class,false, $psdoc, $text, $len, $xcoor, $ycoor);
}
...
{
    Call::invoke('ps_show',PsException::class,false, $psdoc, $text);
}
...
{
    Call::invoke('ps_show2',PsException::class,false, $psdoc, $text, $len);
}
...
{
    Call::invoke('ps_stroke',PsException::class,false, $psdoc);
}
...
{
    Call::invoke('ps_symbol',PsException::class,false, $psdoc, $ord);
}
...
{
    Call::invoke('ps_translate',PsException::class,false, $psdoc, $x, $y);
}
