...
use margusk\Warbsorber\Functions\Exceptions\ImapException;
...
{
    return Call::invoke('imap_8bit',ImapException::class,false, $string);
}
...
function imap_append($imap, string $folder, string $message, string $options = null, string $internal_date = null): void
{
    if ($internal_date !== null) {
        Call::invoke('imap_append',ImapException::class,false, $imap, $folder, $message, $options, $internal_date);
    } elseif ($options !== null) {
        Call::invoke('imap_append',ImapException::class,false, $imap, $folder, $message, $options);
    } else {
        Call::invoke('imap_append',ImapException::class,false, $imap, $folder, $message);
    }
}
...
{
    return Call::invoke('imap_base64',ImapException::class,false, $string);
}
...
{
    return Call::invoke('imap_binary',ImapException::class,false, $string);
}
...
{
    return Call::invoke('imap_body',ImapException::class,false, $imap, $message_num, $flags);
}
...
{
    return Call::invoke('imap_bodystruct',ImapException::class,false, $imap, $message_num, $section);
}
...
{
    return Call::invoke('imap_check',ImapException::class,false, $imap);
}
...
{
    Call::invoke('imap_clearflag_full',ImapException::class,false, $imap, $sequence, $flag, $options);
}
...
{
    Call::invoke('imap_close',ImapException::class,false, $imap, $flags);
}
...
{
    Call::invoke('imap_createmailbox',ImapException::class,false, $imap, $mailbox);
}
...
{
    Call::invoke('imap_deletemailbox',ImapException::class,false, $imap, $mailbox);
}
...
{
    return Call::invoke('imap_fetch_overview',ImapException::class,false, $imap, $sequence, $flags);
}
...
{
    return Call::invoke('imap_fetchbody',ImapException::class,false, $imap, $message_num, $section, $flags);
}
...
{
    return Call::invoke('imap_fetchheader',ImapException::class,false, $imap, $message_num, $flags);
}
...
{
    return Call::invoke('imap_fetchmime',ImapException::class,false, $imap, $message_num, $section, $flags);
}
...
{
    return Call::invoke('imap_fetchstructure',ImapException::class,false, $imap, $message_num, $flags);
}
...
{
    Call::invoke('imap_gc',ImapException::class,false, $imap, $flags);
}
...
{
    return Call::invoke('imap_getacl',ImapException::class,false, $imap, $mailbox);
}
...
{
    return Call::invoke('imap_getmailboxes',ImapException::class,false, $imap, $reference, $pattern);
}
...
{
    return Call::invoke('imap_getsubscribed',ImapException::class,false, $imap, $reference, $pattern);
}
...
{
    return Call::invoke('imap_headerinfo',ImapException::class,false, $imap, $message_num, $from_length, $subject_length);
}
...
{
    return Call::invoke('imap_headers',ImapException::class,false, $imap);
}
...
{
    return Call::invoke('imap_listscan',ImapException::class,false, $imap, $reference, $pattern, $content);
}
...
{
    return Call::invoke('imap_lsub',ImapException::class,false, $imap, $reference, $pattern);
}
...
{
    return Call::invoke('imap_mail_compose',ImapException::class,false, $envelope, $bodies);
}
...
{
    Call::invoke('imap_mail_copy',ImapException::class,false, $imap, $message_nums, $mailbox, $flags);
}
...
{
    Call::invoke('imap_mail_move',ImapException::class,false, $imap, $message_nums, $mailbox, $flags);
}
...
{
    if ($return_path !== null) {
        Call::invoke('imap_mail',ImapException::class,false, $to, $subject, $message, $additional_headers, $cc, $bcc, $return_path);
    } elseif ($bcc !== null) {
        Call::invoke('imap_mail',ImapException::class,false, $to, $subject, $message, $additional_headers, $cc, $bcc);
    } elseif ($cc !== null) {
        Call::invoke('imap_mail',ImapException::class,false, $to, $subject, $message, $additional_headers, $cc);
    } elseif ($additional_headers !== null) {
        Call::invoke('imap_mail',ImapException::class,false, $to, $subject, $message, $additional_headers);
    } else {
        Call::invoke('imap_mail',ImapException::class,false, $to, $subject, $message);
    }
}
...
{
    return Call::invoke('imap_mailboxmsginfo',ImapException::class,false, $imap);
}
...
{
    return Call::invoke('imap_mime_header_decode',ImapException::class,false, $string);
}
...
{
    return Call::invoke('imap_mutf7_to_utf8',ImapException::class,false, $string);
}
...
{
    return Call::invoke('imap_num_msg',ImapException::class,false, $imap);
}
...
{
    return Call::invoke('imap_open',ImapException::class,false, $mailbox, $user, $password, $flags, $retries, $options);
}
...
{
    return Call::invoke('imap_qprint',ImapException::class,false, $string);
}
...
{
    Call::invoke('imap_renamemailbox',ImapException::class,false, $imap, $from, $to);
}
...
{
    return Call::invoke('imap_rfc822_write_address',ImapException::class,false, $mailbox, $hostname, $personal);
}
...
{
    Call::invoke('imap_savebody',ImapException::class,false, $imap, $file, $message_num, $section, $flags);
}
...
{
    Call::invoke('imap_set_quota',ImapException::class,false, $imap, $quota_root, $mailbox_size);
}
...
{
    Call::invoke('imap_setacl',ImapException::class,false, $imap, $mailbox, $user_id, $rights);
}
...
{
    Call::invoke('imap_setflag_full',ImapException::class,false, $imap, $sequence, $flag, $options);
}
...
{
    if ($charset !== null) {
        return Call::invoke('imap_sort',ImapException::class,false, $imap, $criteria, $reverse, $flags, $search_criteria, $charset);
    } elseif ($search_criteria !== null) {
        return Call::invoke('imap_sort',ImapException::class,false, $imap, $criteria, $reverse, $flags, $search_criteria);
    } else {
        return Call::invoke('imap_sort',ImapException::class,false, $imap, $criteria, $reverse, $flags);
    }
}
...
{
    return Call::invoke('imap_status',ImapException::class,false, $imap, $mailbox, $flags);
}
...
{
    Call::invoke('imap_subscribe',ImapException::class,false, $imap, $mailbox);
}
...
{
    return Call::invoke('imap_thread',ImapException::class,false, $imap, $flags);
}
...
{
    return Call::invoke('imap_timeout',ImapException::class,false, $timeout_type, $timeout);
}
...
{
    Call::invoke('imap_undelete',ImapException::class,false, $imap, $message_nums, $flags);
}
...
{
    Call::invoke('imap_unsubscribe',ImapException::class,false, $imap, $mailbox);
}
...
{
    return Call::invoke('imap_utf8_to_mutf7',ImapException::class,false, $string);
}
