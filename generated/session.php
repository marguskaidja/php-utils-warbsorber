...
use margusk\Warbsorber\Functions\Exceptions\SessionException;
...
{
    Call::invoke('session_abort',SessionException::class,false);
}
...
{
    return Call::invoke('session_create_id',SessionException::class,false, $prefix);
}
...
{
    Call::invoke('session_decode',SessionException::class,false, $data);
}
...
{
    Call::invoke('session_destroy',SessionException::class,false);
}
...
{
    return Call::invoke('session_encode',SessionException::class,false);
}
...
{
    if ($id !== null) {
        return Call::invoke('session_id',SessionException::class,false, $id);
    } else {
        return Call::invoke('session_id',SessionException::class,false);
    }
}
...
{
    if ($module !== null) {
        return Call::invoke('session_module_name',SessionException::class,false, $module);
    } else {
        return Call::invoke('session_module_name',SessionException::class,false);
    }
}
...
{
    if ($name !== null) {
        return Call::invoke('session_name',SessionException::class,false, $name);
    } else {
        return Call::invoke('session_name',SessionException::class,false);
    }
}
...
{
    Call::invoke('session_regenerate_id',SessionException::class,false, $delete_old_session);
}
...
{
    Call::invoke('session_reset',SessionException::class,false);
}
...
{
    if ($path !== null) {
        return Call::invoke('session_save_path',SessionException::class,false, $path);
    } else {
        return Call::invoke('session_save_path',SessionException::class,false);
    }
}
...
{
    Call::invoke('session_unset',SessionException::class,false);
}
...
{
    Call::invoke('session_write_close',SessionException::class,false);
}
