...
use margusk\Warbsorber\Functions\Exceptions\StringsException;
...
{
    return Call::invoke('convert_uudecode',StringsException::class,false, $string);
}
...
{
    return Call::invoke('hex2bin',StringsException::class,false, $string);
}
...
{
    return Call::invoke('md5_file',StringsException::class,false, $filename, $binary);
}
...
{
    return Call::invoke('sha1_file',StringsException::class,false, $filename, $binary);
}
