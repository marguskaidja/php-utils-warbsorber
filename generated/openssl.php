...
use margusk\Warbsorber\Functions\Exceptions\OpensslException;
...
{
    return Call::invoke('openssl_cipher_iv_length',OpensslException::class,false, $cipher_algo);
}
...
{
    return Call::invoke('openssl_cipher_key_length',OpensslException::class,false, $cipher_algo);
}
...
function openssl_cms_decrypt(string $input_filename, string $output_filename, $certificate, $private_key = null, int $encoding = OPENSSL_ENCODING_SMIME): void
{
    if ($encoding !== OPENSSL_ENCODING_SMIME) {
        Call::invoke('openssl_cms_decrypt',OpensslException::class,false, $input_filename, $output_filename, $certificate, $private_key, $encoding);
    } elseif ($private_key !== null) {
        Call::invoke('openssl_cms_decrypt',OpensslException::class,false, $input_filename, $output_filename, $certificate, $private_key);
    } else {
        Call::invoke('openssl_cms_decrypt',OpensslException::class,false, $input_filename, $output_filename, $certificate);
    }
}
...
{
    Call::invoke('openssl_cms_encrypt',OpensslException::class,false, $input_filename, $output_filename, $certificate, $headers, $flags, $encoding, $cipher_algo);
}
...
{
    Call::invoke('openssl_cms_read',OpensslException::class,false, $input_filename, $certificates);
}
...
function openssl_cms_sign(string $input_filename, string $output_filename, $certificate, $private_key, $headers, int $flags = 0, int $encoding = OPENSSL_ENCODING_SMIME, $untrusted_certificates_filename = null): void
{
    if ($untrusted_certificates_filename !== null) {
        Call::invoke('openssl_cms_sign',OpensslException::class,false, $input_filename, $output_filename, $certificate, $private_key, $headers, $flags, $encoding, $untrusted_certificates_filename);
    } else {
        Call::invoke('openssl_cms_sign',OpensslException::class,false, $input_filename, $output_filename, $certificate, $private_key, $headers, $flags, $encoding);
    }
}
...
{
    if ($encoding !== OPENSSL_ENCODING_SMIME) {
        Call::invoke('openssl_cms_verify',OpensslException::class,false, $input_filename, $flags, $certificates, $ca_info, $untrusted_certificates_filename, $content, $pk7, $sigfile, $encoding);
    } elseif ($sigfile !== null) {
        Call::invoke('openssl_cms_verify',OpensslException::class,false, $input_filename, $flags, $certificates, $ca_info, $untrusted_certificates_filename, $content, $pk7, $sigfile);
    } elseif ($pk7 !== null) {
        Call::invoke('openssl_cms_verify',OpensslException::class,false, $input_filename, $flags, $certificates, $ca_info, $untrusted_certificates_filename, $content, $pk7);
    } elseif ($content !== null) {
        Call::invoke('openssl_cms_verify',OpensslException::class,false, $input_filename, $flags, $certificates, $ca_info, $untrusted_certificates_filename, $content);
    } elseif ($untrusted_certificates_filename !== null) {
        Call::invoke('openssl_cms_verify',OpensslException::class,false, $input_filename, $flags, $certificates, $ca_info, $untrusted_certificates_filename);
    } elseif ($ca_info !== []) {
        Call::invoke('openssl_cms_verify',OpensslException::class,false, $input_filename, $flags, $certificates, $ca_info);
    } elseif ($certificates !== null) {
        Call::invoke('openssl_cms_verify',OpensslException::class,false, $input_filename, $flags, $certificates);
    } else {
        Call::invoke('openssl_cms_verify',OpensslException::class,false, $input_filename, $flags);
    }
}
...
{
    Call::invoke('openssl_csr_export_to_file',OpensslException::class,false, $csr, $output_filename, $no_text);
}
...
{
    Call::invoke('openssl_csr_export',OpensslException::class,false, $csr, $output, $no_text);
}
...
{
    return Call::invoke('openssl_csr_get_public_key',OpensslException::class,false, $csr, $short_names);
}
...
{
    return Call::invoke('openssl_csr_get_subject',OpensslException::class,false, $csr, $short_names);
}
...
function openssl_csr_new(array $distinguished_names, &$private_key, array $options = null, array $extra_attributes = null)
{
    if ($extra_attributes !== null) {
        return Call::invoke('openssl_csr_new',OpensslException::class,false, $distinguished_names, $private_key, $options, $extra_attributes);
    } elseif ($options !== null) {
        return Call::invoke('openssl_csr_new',OpensslException::class,false, $distinguished_names, $private_key, $options);
    } else {
        return Call::invoke('openssl_csr_new',OpensslException::class,false, $distinguished_names, $private_key);
    }
}
...
{
    if ($serial !== 0) {
        return Call::invoke('openssl_csr_sign',OpensslException::class,false, $csr, $ca_certificate, $private_key, $days, $options, $serial);
    } elseif ($options !== null) {
        return Call::invoke('openssl_csr_sign',OpensslException::class,false, $csr, $ca_certificate, $private_key, $days, $options);
    } else {
        return Call::invoke('openssl_csr_sign',OpensslException::class,false, $csr, $ca_certificate, $private_key, $days);
    }
}
...
{
    if ($aad !== "") {
        return Call::invoke('openssl_decrypt',OpensslException::class,false, $data, $cipher_algo, $passphrase, $options, $iv, $tag, $aad);
    } elseif ($tag !== null) {
        return Call::invoke('openssl_decrypt',OpensslException::class,false, $data, $cipher_algo, $passphrase, $options, $iv, $tag);
    } else {
        return Call::invoke('openssl_decrypt',OpensslException::class,false, $data, $cipher_algo, $passphrase, $options, $iv);
    }
}
...
{
    return Call::invoke('openssl_dh_compute_key',OpensslException::class,false, $public_key, $private_key);
}
...
{
    return Call::invoke('openssl_digest',OpensslException::class,false, $data, $digest_algo, $binary);
}
...
{
    return Call::invoke('openssl_get_curve_names',OpensslException::class,false);
}
...
{
    if ($iv !== null) {
        Call::invoke('openssl_open',OpensslException::class,false, $data, $output, $encrypted_key, $private_key, $cipher_algo, $iv);
    } else {
        Call::invoke('openssl_open',OpensslException::class,false, $data, $output, $encrypted_key, $private_key, $cipher_algo);
    }
}
...
{
    return Call::invoke('openssl_pbkdf2',OpensslException::class,false, $password, $salt, $key_length, $iterations, $digest_algo);
}
...
{
    Call::invoke('openssl_pkcs12_export_to_file',OpensslException::class,false, $certificate, $output_filename, $private_key, $passphrase, $options);
}
...
{
    Call::invoke('openssl_pkcs12_export',OpensslException::class,false, $certificate, $output, $private_key, $passphrase, $options);
}
...
{
    Call::invoke('openssl_pkcs12_read',OpensslException::class,false, $pkcs12, $certificates, $passphrase);
}
...
{
    if ($private_key !== null) {
        Call::invoke('openssl_pkcs7_decrypt',OpensslException::class,false, $input_filename, $output_filename, $certificate, $private_key);
    } else {
        Call::invoke('openssl_pkcs7_decrypt',OpensslException::class,false, $input_filename, $output_filename, $certificate);
    }
}
...
{
    Call::invoke('openssl_pkcs7_encrypt',OpensslException::class,false, $input_filename, $output_filename, $certificate, $headers, $flags, $cipher_algo);
}
...
{
    Call::invoke('openssl_pkcs7_read',OpensslException::class,false, $data, $certificates);
}
...
{
    if ($untrusted_certificates_filename !== null) {
        Call::invoke('openssl_pkcs7_sign',OpensslException::class,false, $input_filename, $output_filename, $certificate, $private_key, $headers, $flags, $untrusted_certificates_filename);
    } else {
        Call::invoke('openssl_pkcs7_sign',OpensslException::class,false, $input_filename, $output_filename, $certificate, $private_key, $headers, $flags);
    }
}
...
{
    return Call::invoke('openssl_pkey_derive',OpensslException::class,false, $public_key, $private_key, $key_length);
}
...
{
    if ($options !== null) {
        Call::invoke('openssl_pkey_export_to_file',OpensslException::class,false, $key, $output_filename, $passphrase, $options);
    } elseif ($passphrase !== null) {
        Call::invoke('openssl_pkey_export_to_file',OpensslException::class,false, $key, $output_filename, $passphrase);
    } else {
        Call::invoke('openssl_pkey_export_to_file',OpensslException::class,false, $key, $output_filename);
    }
}
...
{
    if ($options !== null) {
        Call::invoke('openssl_pkey_export',OpensslException::class,false, $key, $output, $passphrase, $options);
    } elseif ($passphrase !== null) {
        Call::invoke('openssl_pkey_export',OpensslException::class,false, $key, $output, $passphrase);
    } else {
        Call::invoke('openssl_pkey_export',OpensslException::class,false, $key, $output);
    }
}
...
{
    if ($passphrase !== null) {
        return Call::invoke('openssl_pkey_get_private',OpensslException::class,false, $private_key, $passphrase);
    } else {
        return Call::invoke('openssl_pkey_get_private',OpensslException::class,false, $private_key);
    }
}
...
{
    return Call::invoke('openssl_pkey_get_public',OpensslException::class,false, $public_key);
}
...
{
    if ($options !== null) {
        return Call::invoke('openssl_pkey_new',OpensslException::class,false, $options);
    } else {
        return Call::invoke('openssl_pkey_new',OpensslException::class,false);
    }
}
...
{
    Call::invoke('openssl_private_decrypt',OpensslException::class,false, $data, $decrypted_data, $private_key, $padding);
}
...
{
    Call::invoke('openssl_private_encrypt',OpensslException::class,false, $data, $encrypted_data, $private_key, $padding);
}
...
{
    Call::invoke('openssl_public_decrypt',OpensslException::class,false, $data, $decrypted_data, $public_key, $padding);
}
...
{
    Call::invoke('openssl_public_encrypt',OpensslException::class,false, $data, $encrypted_data, $public_key, $padding);
}
...
{
    return Call::invoke('openssl_seal',OpensslException::class,false, $data, $sealed_data, $encrypted_keys, $public_key, $cipher_algo, $iv);
}
...
{
    Call::invoke('openssl_sign',OpensslException::class,false, $data, $signature, $private_key, $algorithm);
}
...
{
    return Call::invoke('openssl_spki_export_challenge',OpensslException::class,false, $spki);
}
...
{
    return Call::invoke('openssl_spki_export',OpensslException::class,false, $spki);
}
...
{
    return Call::invoke('openssl_spki_new',OpensslException::class,false, $private_key, $challenge, $digest_algo);
}
...
{
    Call::invoke('openssl_spki_verify',OpensslException::class,false, $spki);
}
...
{
    return Call::invoke('openssl_verify',OpensslException::class,false, $data, $signature, $public_key, $algorithm);
}
...
{
    Call::invoke('openssl_x509_export_to_file',OpensslException::class,false, $certificate, $output_filename, $no_text);
}
...
{
    Call::invoke('openssl_x509_export',OpensslException::class,false, $certificate, $output, $no_text);
}
...
{
    return Call::invoke('openssl_x509_fingerprint',OpensslException::class,false, $certificate, $digest_algo, $binary);
}
...
{
    return Call::invoke('openssl_x509_read',OpensslException::class,false, $certificate);
}
