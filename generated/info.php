...
use margusk\Warbsorber\Functions\Exceptions\InfoException;
...
{
    if ($value !== null) {
        return Call::invoke('assert_options',InfoException::class,false, $what, $value);
    } else {
        return Call::invoke('assert_options',InfoException::class,false, $what);
    }
}
...
{
    Call::invoke('cli_set_process_title',InfoException::class,false, $title);
}
...
{
    Call::invoke('dl',InfoException::class,false, $extension_filename);
}
...
{
    return Call::invoke('get_include_path',InfoException::class,false);
}
...
{
    return Call::invoke('getlastmod',InfoException::class,false);
}
...
{
    return Call::invoke('getmygid',InfoException::class,false);
}
...
{
    return Call::invoke('getmyinode',InfoException::class,false);
}
...
{
    return Call::invoke('getmypid',InfoException::class,false);
}
...
{
    return Call::invoke('getmyuid',InfoException::class,false);
}
...
{
    return Call::invoke('getopt',InfoException::class,false, $short_options, $long_options, $rest_index);
}
...
{
    return Call::invoke('getrusage',InfoException::class,false, $mode);
}
...
{
    return Call::invoke('ini_get',InfoException::class,false, $option);
}
...
{
    return Call::invoke('ini_set',InfoException::class,false, $option, $value);
}
...
{
    return Call::invoke('php_sapi_name',InfoException::class,false);
}
...
{
    Call::invoke('phpcredits',InfoException::class,false, $flags);
}
...
{
    Call::invoke('phpinfo',InfoException::class,false, $flags);
}
...
{
    Call::invoke('putenv',InfoException::class,false, $assignment);
}
...
{
    return Call::invoke('set_include_path',InfoException::class,false, $include_path);
}
...
{
    Call::invoke('set_time_limit',InfoException::class,false, $seconds);
}
