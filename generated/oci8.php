...
use margusk\Warbsorber\Functions\Exceptions\Oci8Exception;
...
{
    Call::invoke('oci_bind_array_by_name',Oci8Exception::class,false, $statement, $param, $var, $max_array_length, $max_item_length, $type);
}
...
{
    Call::invoke('oci_bind_by_name',Oci8Exception::class,false, $statement, $param, $var, $max_length, $type);
}
...
{
    Call::invoke('oci_cancel',Oci8Exception::class,false, $statement);
}
...
{
    Call::invoke('oci_commit',Oci8Exception::class,false, $connection);
}
...
function oci_connect(string $username, string $password, string $connection_string = null, string $encoding = "", int $session_mode = OCI_DEFAULT)
{
    if ($session_mode !== OCI_DEFAULT) {
        return Call::invoke('oci_connect',Oci8Exception::class,false, $username, $password, $connection_string, $encoding, $session_mode);
    } elseif ($encoding !== "") {
        return Call::invoke('oci_connect',Oci8Exception::class,false, $username, $password, $connection_string, $encoding);
    } elseif ($connection_string !== null) {
        return Call::invoke('oci_connect',Oci8Exception::class,false, $username, $password, $connection_string);
    } else {
        return Call::invoke('oci_connect',Oci8Exception::class,false, $username, $password);
    }
}
...
{
    Call::invoke('oci_define_by_name',Oci8Exception::class,false, $statement, $column, $var, $type);
}
...
{
    Call::invoke('oci_execute',Oci8Exception::class,false, $statement, $mode);
}
...
{
    return Call::invoke('oci_field_name',Oci8Exception::class,false, $statement, $column);
}
...
{
    return Call::invoke('oci_field_precision',Oci8Exception::class,false, $statement, $column);
}
...
{
    return Call::invoke('oci_field_scale',Oci8Exception::class,false, $statement, $column);
}
...
{
    return Call::invoke('oci_field_size',Oci8Exception::class,false, $statement, $column);
}
...
{
    return Call::invoke('oci_field_type_raw',Oci8Exception::class,false, $statement, $column);
}
...
{
    return Call::invoke('oci_field_type',Oci8Exception::class,false, $statement, $column);
}
...
{
    Call::invoke('oci_free_descriptor',Oci8Exception::class,false, $lob);
}
...
{
    Call::invoke('oci_free_statement',Oci8Exception::class,false, $statement);
}
...
{
    if ($schema !== null) {
        return Call::invoke('oci_new_collection',Oci8Exception::class,false, $connection, $type_name, $schema);
    } else {
        return Call::invoke('oci_new_collection',Oci8Exception::class,false, $connection, $type_name);
    }
}
...
{
    if ($session_mode !== OCI_DEFAULT) {
        return Call::invoke('oci_new_connect',Oci8Exception::class,false, $username, $password, $connection_string, $encoding, $session_mode);
    } elseif ($encoding !== "") {
        return Call::invoke('oci_new_connect',Oci8Exception::class,false, $username, $password, $connection_string, $encoding);
    } elseif ($connection_string !== null) {
        return Call::invoke('oci_new_connect',Oci8Exception::class,false, $username, $password, $connection_string);
    } else {
        return Call::invoke('oci_new_connect',Oci8Exception::class,false, $username, $password);
    }
}
...
{
    return Call::invoke('oci_new_cursor',Oci8Exception::class,false, $connection);
}
...
{
    return Call::invoke('oci_new_descriptor',Oci8Exception::class,null, $connection, $type);
}
...
{
    return Call::invoke('oci_num_rows',Oci8Exception::class,false, $statement);
}
...
{
    return Call::invoke('oci_parse',Oci8Exception::class,false, $connection, $sql);
}
...
{
    if ($session_mode !== OCI_DEFAULT) {
        return Call::invoke('oci_pconnect',Oci8Exception::class,false, $username, $password, $connection_string, $encoding, $session_mode);
    } elseif ($encoding !== "") {
        return Call::invoke('oci_pconnect',Oci8Exception::class,false, $username, $password, $connection_string, $encoding);
    } elseif ($connection_string !== null) {
        return Call::invoke('oci_pconnect',Oci8Exception::class,false, $username, $password, $connection_string);
    } else {
        return Call::invoke('oci_pconnect',Oci8Exception::class,false, $username, $password);
    }
}
...
{
    Call::invoke('oci_register_taf_callback',Oci8Exception::class,false, $connection, $callback);
}
...
{
    return Call::invoke('oci_result',Oci8Exception::class,false, $statement, $column);
}
...
{
    Call::invoke('oci_rollback',Oci8Exception::class,false, $connection);
}
...
{
    return Call::invoke('oci_server_version',Oci8Exception::class,false, $connection);
}
...
{
    Call::invoke('oci_set_action',Oci8Exception::class,false, $connection, $action);
}
...
{
    Call::invoke('oci_set_call_timeout',Oci8Exception::class,false, $connection, $timeout);
}
...
{
    Call::invoke('oci_set_client_identifier',Oci8Exception::class,false, $connection, $client_id);
}
...
{
    Call::invoke('oci_set_client_info',Oci8Exception::class,false, $connection, $client_info);
}
...
{
    Call::invoke('oci_set_db_operation',Oci8Exception::class,false, $connection, $action);
}
...
{
    Call::invoke('oci_set_edition',Oci8Exception::class,false, $edition);
}
...
{
    Call::invoke('oci_set_module_name',Oci8Exception::class,false, $connection, $name);
}
...
{
    Call::invoke('oci_set_prefetch_lob',Oci8Exception::class,false, $statement, $prefetch_lob_size);
}
...
{
    Call::invoke('oci_set_prefetch',Oci8Exception::class,false, $statement, $rows);
}
...
{
    return Call::invoke('oci_statement_type',Oci8Exception::class,false, $statement);
}
...
{
    Call::invoke('oci_unregister_taf_callback',Oci8Exception::class,false, $connection);
}
