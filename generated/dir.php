...
use margusk\Warbsorber\Functions\Exceptions\DirException;
...
{
    Call::invoke('chdir',DirException::class,false, $directory);
}
...
{
    Call::invoke('chroot',DirException::class,false, $directory);
}
...
{
    return Call::invoke('getcwd',DirException::class,false);
}
...
{
    if ($context !== null) {
        return Call::invoke('opendir',DirException::class,false, $directory, $context);
    } else {
        return Call::invoke('opendir',DirException::class,false, $directory);
    }
}
...
{
    if ($context !== null) {
        return Call::invoke('scandir',DirException::class,false, $directory, $sorting_order, $context);
    } else {
        return Call::invoke('scandir',DirException::class,false, $directory, $sorting_order);
    }
}
