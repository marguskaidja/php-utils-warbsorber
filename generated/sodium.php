...
use margusk\Warbsorber\Functions\Exceptions\SodiumException;
...
{
    return Call::invoke('sodium_crypto_aead_aes256gcm_decrypt',SodiumException::class,false, $ciphertext, $additional_data, $nonce, $key);
}
...
{
    return Call::invoke('sodium_crypto_aead_chacha20poly1305_decrypt',SodiumException::class,false, $ciphertext, $additional_data, $nonce, $key);
}
...
{
    return Call::invoke('sodium_crypto_aead_chacha20poly1305_encrypt',SodiumException::class,false, $message, $additional_data, $nonce, $key);
}
...
{
    return Call::invoke('sodium_crypto_aead_chacha20poly1305_ietf_decrypt',SodiumException::class,false, $ciphertext, $additional_data, $nonce, $key);
}
...
{
    return Call::invoke('sodium_crypto_aead_chacha20poly1305_ietf_encrypt',SodiumException::class,false, $message, $additional_data, $nonce, $key);
}
...
{
    return Call::invoke('sodium_crypto_aead_xchacha20poly1305_ietf_decrypt',SodiumException::class,false, $ciphertext, $additional_data, $nonce, $key);
}
...
{
    return Call::invoke('sodium_crypto_aead_xchacha20poly1305_ietf_encrypt',SodiumException::class,false, $message, $additional_data, $nonce, $key);
}
...
{
    Call::invoke('sodium_crypto_auth_verify',SodiumException::class,false, $mac, $message, $key);
}
...
{
    return Call::invoke('sodium_crypto_box_open',SodiumException::class,false, $ciphertext, $nonce, $key_pair);
}
...
{
    return Call::invoke('sodium_crypto_box_seal_open',SodiumException::class,false, $ciphertext, $key_pair);
}
...
{
    Call::invoke('sodium_crypto_generichash_update',SodiumException::class,false, $state, $message);
}
...
{
    return Call::invoke('sodium_crypto_secretbox_open',SodiumException::class,false, $ciphertext, $nonce, $key);
}
...
{
    return Call::invoke('sodium_crypto_sign_open',SodiumException::class,false, $signed_message, $public_key);
}
...
{
    Call::invoke('sodium_crypto_sign_verify_detached',SodiumException::class,false, $signature, $message, $public_key);
}
...
{
    return Call::invoke('sodium_crypto_stream_xchacha20_xor_ic',SodiumException::class,false, $message, $nonce, $counter, $key);
}
