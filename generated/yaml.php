...
use margusk\Warbsorber\Functions\Exceptions\YamlException;
...
{
    if ($callbacks !== null) {
        return Call::invoke('yaml_parse_file',YamlException::class,false, $filename, $pos, $ndocs, $callbacks);
    } else {
        return Call::invoke('yaml_parse_file',YamlException::class,false, $filename, $pos, $ndocs);
    }
}
...
{
    if ($callbacks !== null) {
        return Call::invoke('yaml_parse_url',YamlException::class,false, $url, $pos, $ndocs, $callbacks);
    } else {
        return Call::invoke('yaml_parse_url',YamlException::class,false, $url, $pos, $ndocs);
    }
}
...
{
    if ($callbacks !== null) {
        return Call::invoke('yaml_parse',YamlException::class,false, $input, $pos, $ndocs, $callbacks);
    } else {
        return Call::invoke('yaml_parse',YamlException::class,false, $input, $pos, $ndocs);
    }
}
