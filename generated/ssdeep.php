...
use margusk\Warbsorber\Functions\Exceptions\SsdeepException;
...
{
    return Call::invoke('ssdeep_fuzzy_compare',SsdeepException::class,false, $signature1, $signature2);
}
...
{
    return Call::invoke('ssdeep_fuzzy_hash_filename',SsdeepException::class,false, $file_name);
}
...
{
    return Call::invoke('ssdeep_fuzzy_hash',SsdeepException::class,false, $to_hash);
}
