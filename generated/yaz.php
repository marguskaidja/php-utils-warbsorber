...
use margusk\Warbsorber\Functions\Exceptions\YazException;
...
{
    Call::invoke('yaz_ccl_parse',YazException::class,false, $id, $query, $result);
}
...
{
    Call::invoke('yaz_close',YazException::class,false, $id);
}
...
{
    if ($options !== null) {
        return Call::invoke('yaz_connect',YazException::class,false, $zurl, $options);
    } else {
        return Call::invoke('yaz_connect',YazException::class,false, $zurl);
    }
}
...
{
    Call::invoke('yaz_database',YazException::class,false, $id, $databases);
}
...
{
    Call::invoke('yaz_element',YazException::class,false, $id, $elementset);
}
...
{
    Call::invoke('yaz_present',YazException::class,false, $id);
}
...
{
    Call::invoke('yaz_search',YazException::class,false, $id, $type, $query);
}
...
{
    return Call::invoke('yaz_wait',YazException::class,false, $options);
}
