...
use margusk\Warbsorber\Functions\Exceptions\DatetimeException;
...
{
    return Call::invoke('date_parse_from_format',DatetimeException::class,false, $format, $datetime);
}
...
{
    return Call::invoke('date_parse',DatetimeException::class,false, $datetime);
}
...
{
    return Call::invoke('date_sun_info',DatetimeException::class,false, $timestamp, $latitude, $longitude);
}
...
{
    if ($utcOffset !== null) {
        return Call::invoke('date_sunrise',DatetimeException::class,false, $timestamp, $returnFormat, $latitude, $longitude, $zenith, $utcOffset);
    } elseif ($zenith !== null) {
        return Call::invoke('date_sunrise',DatetimeException::class,false, $timestamp, $returnFormat, $latitude, $longitude, $zenith);
    } elseif ($longitude !== null) {
        return Call::invoke('date_sunrise',DatetimeException::class,false, $timestamp, $returnFormat, $latitude, $longitude);
    } elseif ($latitude !== null) {
        return Call::invoke('date_sunrise',DatetimeException::class,false, $timestamp, $returnFormat, $latitude);
    } else {
        return Call::invoke('date_sunrise',DatetimeException::class,false, $timestamp, $returnFormat);
    }
}
...
{
    if ($utcOffset !== null) {
        return Call::invoke('date_sunset',DatetimeException::class,false, $timestamp, $returnFormat, $latitude, $longitude, $zenith, $utcOffset);
    } elseif ($zenith !== null) {
        return Call::invoke('date_sunset',DatetimeException::class,false, $timestamp, $returnFormat, $latitude, $longitude, $zenith);
    } elseif ($longitude !== null) {
        return Call::invoke('date_sunset',DatetimeException::class,false, $timestamp, $returnFormat, $latitude, $longitude);
    } elseif ($latitude !== null) {
        return Call::invoke('date_sunset',DatetimeException::class,false, $timestamp, $returnFormat, $latitude);
    } else {
        return Call::invoke('date_sunset',DatetimeException::class,false, $timestamp, $returnFormat);
    }
}
...
{
    if ($timestamp !== null) {
        return Call::invoke('date',DatetimeException::class,false, $format, $timestamp);
    } else {
        return Call::invoke('date',DatetimeException::class,false, $format);
    }
}
...
{
    if ($year !== null) {
        return Call::invoke('gmmktime',DatetimeException::class,false, $hour, $minute, $second, $month, $day, $year);
    } elseif ($day !== null) {
        return Call::invoke('gmmktime',DatetimeException::class,false, $hour, $minute, $second, $month, $day);
    } elseif ($month !== null) {
        return Call::invoke('gmmktime',DatetimeException::class,false, $hour, $minute, $second, $month);
    } elseif ($second !== null) {
        return Call::invoke('gmmktime',DatetimeException::class,false, $hour, $minute, $second);
    } elseif ($minute !== null) {
        return Call::invoke('gmmktime',DatetimeException::class,false, $hour, $minute);
    } else {
        return Call::invoke('gmmktime',DatetimeException::class,false, $hour);
    }
}
...
{
    if ($timestamp !== null) {
        return Call::invoke('gmstrftime',DatetimeException::class,false, $format, $timestamp);
    } else {
        return Call::invoke('gmstrftime',DatetimeException::class,false, $format);
    }
}
...
{
    if ($timestamp !== null) {
        return Call::invoke('idate',DatetimeException::class,false, $format, $timestamp);
    } else {
        return Call::invoke('idate',DatetimeException::class,false, $format);
    }
}
...
{
    if ($timestamp !== null) {
        return Call::invoke('strftime',DatetimeException::class,false, $format, $timestamp);
    } else {
        return Call::invoke('strftime',DatetimeException::class,false, $format);
    }
}
...
{
    return Call::invoke('strptime',DatetimeException::class,false, $timestamp, $format);
}
...
function strtotime(string $datetime, int $baseTimestamp = null): int
{
    if ($baseTimestamp !== null) {
        return Call::invoke('strtotime',DatetimeException::class,false, $datetime, $baseTimestamp);
    } else {
        return Call::invoke('strtotime',DatetimeException::class,false, $datetime);
    }
}
...
{
    return Call::invoke('timezone_name_from_abbr',DatetimeException::class,false, $abbr, $utcOffset, $isDST);
}
