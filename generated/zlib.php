...
use margusk\Warbsorber\Functions\Exceptions\ZlibException;
...
{
    return Call::invoke('deflate_add',ZlibException::class,false, $context, $data, $flush_mode);
}
...
{
    return Call::invoke('deflate_init',ZlibException::class,false, $encoding, $options);
}
...
{
    Call::invoke('gzclose',ZlibException::class,false, $stream);
}
...
{
    return Call::invoke('gzcompress',ZlibException::class,false, $data, $level, $encoding);
}
...
{
    return Call::invoke('gzdecode',ZlibException::class,false, $data, $max_length);
}
...
{
    return Call::invoke('gzdeflate',ZlibException::class,false, $data, $level, $encoding);
}
...
{
    return Call::invoke('gzencode',ZlibException::class,false, $data, $level, $encoding);
}
...
{
    return Call::invoke('gzfile',ZlibException::class,false, $filename, $use_include_path);
}
...
{
    if ($length !== null) {
        return Call::invoke('gzgets',ZlibException::class,false, $stream, $length);
    } else {
        return Call::invoke('gzgets',ZlibException::class,false, $stream);
    }
}
...
function gzgetss($zp, int $length, string $allowable_tags = null): string
{
    if ($allowable_tags !== null) {
        return Call::invoke('gzgetss',ZlibException::class,false, $zp, $length, $allowable_tags);
    } else {
        return Call::invoke('gzgetss',ZlibException::class,false, $zp, $length);
    }
}
...
{
    return Call::invoke('gzinflate',ZlibException::class,false, $data, $max_length);
}
...
{
    return Call::invoke('gzopen',ZlibException::class,false, $filename, $mode, $use_include_path);
}
...
{
    return Call::invoke('gzpassthru',ZlibException::class,false, $stream);
}
...
{
    return Call::invoke('gzread',ZlibException::class,false, $stream, $length);
}
...
{
    Call::invoke('gzrewind',ZlibException::class,false, $stream);
}
...
{
    return Call::invoke('gzuncompress',ZlibException::class,false, $data, $max_length);
}
...
{
    if ($length !== null) {
        return Call::invoke('gzwrite',ZlibException::class,false, $stream, $data, $length);
    } else {
        return Call::invoke('gzwrite',ZlibException::class,false, $stream, $data);
    }
}
...
{
    return Call::invoke('inflate_get_read_len',ZlibException::class,false, $context);
}
...
{
    return Call::invoke('inflate_get_status',ZlibException::class,false, $context);
}
...
{
    return Call::invoke('inflate_add',ZlibException::class,false, $context, $data, $flush_mode);
}
...
{
    return Call::invoke('inflate_init',ZlibException::class,false, $encoding, $options);
}
...
{
    return Call::invoke('readgzfile',ZlibException::class,false, $filename, $use_include_path);
}
...
{
    return Call::invoke('zlib_decode',ZlibException::class,false, $data, $max_length);
}
