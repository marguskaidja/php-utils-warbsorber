...
use margusk\Warbsorber\Functions\Exceptions\MailparseException;
...
function mailparse_msg_extract_part_file($mimemail, $filename, callable $callbackfunc = null): string
{
    if ($callbackfunc !== null) {
        return Call::invoke('mailparse_msg_extract_part_file',MailparseException::class,false, $mimemail, $filename, $callbackfunc);
    } else {
        return Call::invoke('mailparse_msg_extract_part_file',MailparseException::class,false, $mimemail, $filename);
    }
}
...
{
    Call::invoke('mailparse_msg_free',MailparseException::class,false, $mimemail);
}
...
{
    return Call::invoke('mailparse_msg_parse_file',MailparseException::class,false, $filename);
}
...
{
    Call::invoke('mailparse_msg_parse',MailparseException::class,false, $mimemail, $data);
}
...
{
    Call::invoke('mailparse_stream_encode',MailparseException::class,false, $sourcefp, $destfp, $encoding);
}
