...
use margusk\Warbsorber\Functions\Exceptions\UrlException;
...
{
    return Call::invoke('base64_decode',UrlException::class,false, $string, $strict);
}
...
{
    if ($context !== null) {
        return Call::invoke('get_headers',UrlException::class,false, $url, $associative, $context);
    } else {
        return Call::invoke('get_headers',UrlException::class,false, $url, $associative);
    }
}
...
{
    return Call::invoke('get_meta_tags',UrlException::class,false, $filename, $use_include_path);
}
...
{
    return Call::invoke('parse_url',UrlException::class,false, $url, $component);
}
