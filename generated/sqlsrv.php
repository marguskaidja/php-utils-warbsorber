...
use margusk\Warbsorber\Functions\Exceptions\SqlsrvException;
...
{
    Call::invoke('sqlsrv_begin_transaction',SqlsrvException::class,false, $conn);
}
...
{
    Call::invoke('sqlsrv_cancel',SqlsrvException::class,false, $stmt);
}
...
{
    return Call::invoke('sqlsrv_client_info',SqlsrvException::class,false, $conn);
}
...
{
    Call::invoke('sqlsrv_close',SqlsrvException::class,false, $conn);
}
...
{
    Call::invoke('sqlsrv_commit',SqlsrvException::class,false, $conn);
}
...
{
    Call::invoke('sqlsrv_configure',SqlsrvException::class,false, $setting, $value);
}
...
{
    Call::invoke('sqlsrv_execute',SqlsrvException::class,false, $stmt);
}
...
{
    Call::invoke('sqlsrv_free_stmt',SqlsrvException::class,false, $stmt);
}
...
{
    if ($getAsType !== null) {
        return Call::invoke('sqlsrv_get_field',SqlsrvException::class,false, $stmt, $fieldIndex, $getAsType);
    } else {
        return Call::invoke('sqlsrv_get_field',SqlsrvException::class,false, $stmt, $fieldIndex);
    }
}
...
{
    return Call::invoke('sqlsrv_next_result',SqlsrvException::class,false, $stmt);
}
...
{
    return Call::invoke('sqlsrv_num_fields',SqlsrvException::class,false, $stmt);
}
...
{
    return Call::invoke('sqlsrv_num_rows',SqlsrvException::class,false, $stmt);
}
...
{
    if ($options !== null) {
        return Call::invoke('sqlsrv_prepare',SqlsrvException::class,false, $conn, $sql, $params, $options);
    } elseif ($params !== null) {
        return Call::invoke('sqlsrv_prepare',SqlsrvException::class,false, $conn, $sql, $params);
    } else {
        return Call::invoke('sqlsrv_prepare',SqlsrvException::class,false, $conn, $sql);
    }
}
...
{
    if ($options !== null) {
        return Call::invoke('sqlsrv_query',SqlsrvException::class,false, $conn, $sql, $params, $options);
    } elseif ($params !== null) {
        return Call::invoke('sqlsrv_query',SqlsrvException::class,false, $conn, $sql, $params);
    } else {
        return Call::invoke('sqlsrv_query',SqlsrvException::class,false, $conn, $sql);
    }
}
...
{
    Call::invoke('sqlsrv_rollback',SqlsrvException::class,false, $conn);
}
