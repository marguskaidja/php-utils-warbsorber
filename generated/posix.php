...
use margusk\Warbsorber\Functions\Exceptions\PosixException;
...
{
    Call::invoke('posix_access',PosixException::class,false, $filename, $flags);
}
...
{
    return Call::invoke('posix_getgrgid',PosixException::class,false, $group_id);
}
...
{
    return Call::invoke('posix_getgrnam',PosixException::class,false, $name);
}
...
{
    return Call::invoke('posix_getgroups',PosixException::class,false);
}
...
{
    return Call::invoke('posix_getlogin',PosixException::class,false);
}
...
{
    return Call::invoke('posix_getpwuid',PosixException::class,false, $user_id);
}
...
{
    return Call::invoke('posix_getrlimit',PosixException::class,false);
}
...
{
    return Call::invoke('posix_getsid',PosixException::class,false, $process_id);
}
...
{
    Call::invoke('posix_initgroups',PosixException::class,false, $username, $group_id);
}
...
{
    Call::invoke('posix_kill',PosixException::class,false, $process_id, $signal);
}
...
{
    Call::invoke('posix_mkfifo',PosixException::class,false, $filename, $permissions);
}
...
{
    Call::invoke('posix_mknod',PosixException::class,false, $filename, $flags, $major, $minor);
}
...
{
    Call::invoke('posix_setegid',PosixException::class,false, $group_id);
}
...
{
    Call::invoke('posix_seteuid',PosixException::class,false, $user_id);
}
...
{
    Call::invoke('posix_setgid',PosixException::class,false, $group_id);
}
...
{
    Call::invoke('posix_setpgid',PosixException::class,false, $process_id, $process_group_id);
}
...
{
    Call::invoke('posix_setrlimit',PosixException::class,false, $resource, $soft_limit, $hard_limit);
}
...
{
    Call::invoke('posix_setuid',PosixException::class,false, $user_id);
}
...
{
    return Call::invoke('posix_times',PosixException::class,false);
}
...
{
    return Call::invoke('posix_uname',PosixException::class,false);
}
