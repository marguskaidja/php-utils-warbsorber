...
use margusk\Warbsorber\Functions\Exceptions\FilesystemException;
...
{
    Call::invoke('chgrp',FilesystemException::class,false, $filename, $group);
}
...
{
    Call::invoke('chmod',FilesystemException::class,false, $filename, $permissions);
}
...
{
    Call::invoke('chown',FilesystemException::class,false, $filename, $user);
}
...
{
    if ($context !== null) {
        Call::invoke('copy',FilesystemException::class,false, $from, $to, $context);
    } else {
        Call::invoke('copy',FilesystemException::class,false, $from, $to);
    }
}
...
{
    return Call::invoke('disk_free_space',FilesystemException::class,false, $directory);
}
...
{
    return Call::invoke('disk_total_space',FilesystemException::class,false, $directory);
}
...
{
    Call::invoke('fclose',FilesystemException::class,false, $stream);
}
...
{
    Call::invoke('fdatasync',FilesystemException::class,false, $stream);
}
...
{
    Call::invoke('fflush',FilesystemException::class,false, $stream);
}
...
{
    if ($length !== null) {
        return Call::invoke('file_get_contents',FilesystemException::class,false, $filename, $use_include_path, $context, $offset, $length);
    } elseif ($offset !== 0) {
        return Call::invoke('file_get_contents',FilesystemException::class,false, $filename, $use_include_path, $context, $offset);
    } elseif ($context !== null) {
        return Call::invoke('file_get_contents',FilesystemException::class,false, $filename, $use_include_path, $context);
    } else {
        return Call::invoke('file_get_contents',FilesystemException::class,false, $filename, $use_include_path);
    }
}
...
{
    if ($context !== null) {
        return Call::invoke('file_put_contents',FilesystemException::class,false, $filename, $data, $flags, $context);
    } else {
        return Call::invoke('file_put_contents',FilesystemException::class,false, $filename, $data, $flags);
    }
}
...
{
    if ($context !== null) {
        return Call::invoke('file',FilesystemException::class,false, $filename, $flags, $context);
    } else {
        return Call::invoke('file',FilesystemException::class,false, $filename, $flags);
    }
}
...
{
    return Call::invoke('fileatime',FilesystemException::class,false, $filename);
}
...
{
    return Call::invoke('filectime',FilesystemException::class,false, $filename);
}
...
{
    return Call::invoke('fileinode',FilesystemException::class,false, $filename);
}
...
{
    return Call::invoke('filemtime',FilesystemException::class,false, $filename);
}
...
{
    return Call::invoke('fileowner',FilesystemException::class,false, $filename);
}
...
{
    return Call::invoke('fileperms',FilesystemException::class,false, $filename);
}
...
{
    return Call::invoke('filesize',FilesystemException::class,false, $filename);
}
...
{
    Call::invoke('flock',FilesystemException::class,false, $stream, $operation, $would_block);
}
...
{
    if ($context !== null) {
        return Call::invoke('fopen',FilesystemException::class,false, $filename, $mode, $use_include_path, $context);
    } else {
        return Call::invoke('fopen',FilesystemException::class,false, $filename, $mode, $use_include_path);
    }
}
...
{
    return Call::invoke('fread',FilesystemException::class,false, $stream, $length);
}
...
{
    return Call::invoke('fstat',FilesystemException::class,false, $stream);
}
...
{
    Call::invoke('fsync',FilesystemException::class,false, $stream);
}
...
{
    Call::invoke('ftruncate',FilesystemException::class,false, $stream, $size);
}
...
{
    if ($length !== null) {
        return Call::invoke('fwrite',FilesystemException::class,false, $stream, $data, $length);
    } else {
        return Call::invoke('fwrite',FilesystemException::class,false, $stream, $data);
    }
}
...
{
    return Call::invoke('glob',FilesystemException::class,false, $pattern, $flags);
}
...
{
    Call::invoke('lchgrp',FilesystemException::class,false, $filename, $group);
}
...
{
    Call::invoke('lchown',FilesystemException::class,false, $filename, $user);
}
...
{
    Call::invoke('link',FilesystemException::class,false, $target, $link);
}
...
{
    return Call::invoke('lstat',FilesystemException::class,false, $filename);
}
...
{
    if ($context !== null) {
        Call::invoke('mkdir',FilesystemException::class,false, $directory, $permissions, $recursive, $context);
    } else {
        Call::invoke('mkdir',FilesystemException::class,false, $directory, $permissions, $recursive);
    }
}
...
{
    return Call::invoke('parse_ini_file',FilesystemException::class,false, $filename, $process_sections, $scanner_mode);
}
...
{
    return Call::invoke('parse_ini_string',FilesystemException::class,false, $ini_string, $process_sections, $scanner_mode);
}
...
{
    if ($context !== null) {
        return Call::invoke('readfile',FilesystemException::class,false, $filename, $use_include_path, $context);
    } else {
        return Call::invoke('readfile',FilesystemException::class,false, $filename, $use_include_path);
    }
}
...
{
    return Call::invoke('readlink',FilesystemException::class,false, $path);
}
...
{
    return Call::invoke('realpath',FilesystemException::class,false, $path);
}
...
{
    if ($context !== null) {
        Call::invoke('rename',FilesystemException::class,false, $from, $to, $context);
    } else {
        Call::invoke('rename',FilesystemException::class,false, $from, $to);
    }
}
...
{
    Call::invoke('rewind',FilesystemException::class,false, $stream);
}
...
{
    if ($context !== null) {
        Call::invoke('rmdir',FilesystemException::class,false, $directory, $context);
    } else {
        Call::invoke('rmdir',FilesystemException::class,false, $directory);
    }
}
...
{
    Call::invoke('symlink',FilesystemException::class,false, $target, $link);
}
...
{
    return Call::invoke('tempnam',FilesystemException::class,false, $directory, $prefix);
}
...
function tmpfile()
{
    return Call::invoke('tmpfile',FilesystemException::class,false);
}
...
{
    if ($atime !== null) {
        Call::invoke('touch',FilesystemException::class,false, $filename, $mtime, $atime);
    } elseif ($mtime !== null) {
        Call::invoke('touch',FilesystemException::class,false, $filename, $mtime);
    } else {
        Call::invoke('touch',FilesystemException::class,false, $filename);
    }
}
...
{
    if ($context !== null) {
        Call::invoke('unlink',FilesystemException::class,false, $filename, $context);
    } else {
        Call::invoke('unlink',FilesystemException::class,false, $filename);
    }
}
