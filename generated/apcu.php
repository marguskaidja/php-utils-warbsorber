...
use margusk\Warbsorber\Functions\Exceptions\ApcuException;
...
{
    return Call::invoke('apcu_cache_info',ApcuException::class,false, $limited);
}
...
{
    Call::invoke('apcu_cas',ApcuException::class,false, $key, $old, $new);
}
...
{
    return Call::invoke('apcu_dec',ApcuException::class,false, $key, $step, $success, $ttl);
}
...
{
    return Call::invoke('apcu_inc',ApcuException::class,false, $key, $step, $success, $ttl);
}
...
{
    return Call::invoke('apcu_sma_info',ApcuException::class,false, $limited);
}
