...
use margusk\Warbsorber\Functions\Exceptions\PcreException;
...
{
    return Call::invoke('preg_grep',PcreException::class,false, $pattern, $array, $flags);
}
...
{
    return Call::invoke('preg_match_all',PcreException::class,false, $pattern, $subject, $matches, $flags, $offset);
}
...
{
    return Call::invoke('preg_match',PcreException::class,false, $pattern, $subject, $matches, $flags, $offset);
}
...
{
    return Call::invoke('preg_split',PcreException::class,false, $pattern, $subject, $limit, $flags);
}
