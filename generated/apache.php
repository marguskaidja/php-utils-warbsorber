...
use margusk\Warbsorber\Functions\Exceptions\ApacheException;
...
{
    return Call::invoke('apache_get_version',ApacheException::class,false);
}
...
{
    return Call::invoke('apache_getenv',ApacheException::class,false, $variable, $walk_to_top);
}
...
{
    return Call::invoke('apache_lookup_uri',ApacheException::class,false, $filename);
}
...
{
    return Call::invoke('apache_request_headers',ApacheException::class,false);
}
...
{
    return Call::invoke('apache_response_headers',ApacheException::class,false);
}
...
{
    Call::invoke('apache_setenv',ApacheException::class,false, $variable, $value, $walk_to_top);
}
...
{
    return Call::invoke('getallheaders',ApacheException::class,false);
}
...
{
    Call::invoke('virtual',ApacheException::class,false, $uri);
}
