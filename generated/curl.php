...
use margusk\Warbsorber\Functions\Exceptions\CurlException;
...
{
    return Call::invoke('curl_copy_handle',CurlException::class,false, $handle);
}
...
{
    return Call::invoke('curl_escape',CurlException::class,false, $handle, $string);
}
...
{
    return Call::invoke('curl_exec',CurlException::class,false, $handle);
}
...
{
    if ($option !== null) {
        return Call::invoke('curl_getinfo',CurlException::class,false, $handle, $option);
    } else {
        return Call::invoke('curl_getinfo',CurlException::class,false, $handle);
    }
}
...
{
    if ($url !== null) {
        return Call::invoke('curl_init',CurlException::class,false, $url);
    } else {
        return Call::invoke('curl_init',CurlException::class,false);
    }
}
...
{
    return Call::invoke('curl_multi_info_read',CurlException::class,false, $multi_handle, $queued_messages);
}
...
{
    return Call::invoke('curl_multi_init',CurlException::class,false);
}
...
{
    Call::invoke('curl_multi_setopt',CurlException::class,false, $multi_handle, $option, $value);
}
...
{
    Call::invoke('curl_setopt',CurlException::class,false, $handle, $option, $value);
}
...
{
    return Call::invoke('curl_share_errno',CurlException::class,false, $share_handle);
}
...
{
    Call::invoke('curl_share_setopt',CurlException::class,false, $share_handle, $option, $value);
}
...
{
    return Call::invoke('curl_unescape',CurlException::class,false, $handle, $string);
}
...
{
    Call::invoke('curl_upkeep',CurlException::class,false, $handle);
}
