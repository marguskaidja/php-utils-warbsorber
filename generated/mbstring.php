...
use margusk\Warbsorber\Functions\Exceptions\MbstringException;
...
{
    if ($encoding !== null) {
        return Call::invoke('mb_chr',MbstringException::class,false, $codepoint, $encoding);
    } else {
        return Call::invoke('mb_chr',MbstringException::class,false, $codepoint);
    }
}
...
function mb_convert_encoding($string, string $to_encoding, $from_encoding = null)
{
    if ($from_encoding !== null) {
        return Call::invoke('mb_convert_encoding',MbstringException::class,false, $string, $to_encoding, $from_encoding);
    } else {
        return Call::invoke('mb_convert_encoding',MbstringException::class,false, $string, $to_encoding);
    }
}
...
{
    if ($encoding !== null) {
        return Call::invoke('mb_detect_order',MbstringException::class,false, $encoding);
    } else {
        return Call::invoke('mb_detect_order',MbstringException::class,false);
    }
}
...
{
    return Call::invoke('mb_encoding_aliases',MbstringException::class,false, $encoding);
}
...
{
    if ($options !== null) {
        return Call::invoke('mb_ereg_replace_callback',MbstringException::class,false, $pattern, $callback, $string, $options);
    } else {
        return Call::invoke('mb_ereg_replace_callback',MbstringException::class,false, $pattern, $callback, $string);
    }
}
...
{
    if ($options !== null) {
        return Call::invoke('mb_ereg_replace',MbstringException::class,false, $pattern, $replacement, $string, $options);
    } else {
        return Call::invoke('mb_ereg_replace',MbstringException::class,false, $pattern, $replacement, $string);
    }
}
...
{
    return Call::invoke('mb_ereg_search_getregs',MbstringException::class,false);
}
...
{
    if ($options !== null) {
        Call::invoke('mb_ereg_search_init',MbstringException::class,false, $string, $pattern, $options);
    } elseif ($pattern !== null) {
        Call::invoke('mb_ereg_search_init',MbstringException::class,false, $string, $pattern);
    } else {
        Call::invoke('mb_ereg_search_init',MbstringException::class,false, $string);
    }
}
...
{
    if ($options !== null) {
        return Call::invoke('mb_ereg_search_regs',MbstringException::class,false, $pattern, $options);
    } elseif ($pattern !== null) {
        return Call::invoke('mb_ereg_search_regs',MbstringException::class,false, $pattern);
    } else {
        return Call::invoke('mb_ereg_search_regs',MbstringException::class,false);
    }
}
...
{
    Call::invoke('mb_ereg_search_setpos',MbstringException::class,false, $offset);
}
...
{
    if ($options !== null) {
        return Call::invoke('mb_eregi_replace',MbstringException::class,false, $pattern, $replacement, $string, $options);
    } else {
        return Call::invoke('mb_eregi_replace',MbstringException::class,false, $pattern, $replacement, $string);
    }
}
...
{
    return Call::invoke('mb_get_info',MbstringException::class,false, $type);
}
...
{
    if ($encoding !== null) {
        return Call::invoke('mb_http_output',MbstringException::class,false, $encoding);
    } else {
        return Call::invoke('mb_http_output',MbstringException::class,false);
    }
}
...
{
    if ($encoding !== null) {
        return Call::invoke('mb_internal_encoding',MbstringException::class,false, $encoding);
    } else {
        return Call::invoke('mb_internal_encoding',MbstringException::class,false);
    }
}
...
{
    if ($encoding !== null) {
        return Call::invoke('mb_ord',MbstringException::class,false, $string, $encoding);
    } else {
        return Call::invoke('mb_ord',MbstringException::class,false, $string);
    }
}
...
{
    Call::invoke('mb_parse_str',MbstringException::class,false, $string, $result);
}
...
{
    if ($encoding !== null) {
        return Call::invoke('mb_regex_encoding',MbstringException::class,false, $encoding);
    } else {
        return Call::invoke('mb_regex_encoding',MbstringException::class,false);
    }
}
...
function mb_send_mail(string $to, string $subject, string $message, $additional_headers = [], string $additional_params = null): void
{
    if ($additional_params !== null) {
        Call::invoke('mb_send_mail',MbstringException::class,false, $to, $subject, $message, $additional_headers, $additional_params);
    } else {
        Call::invoke('mb_send_mail',MbstringException::class,false, $to, $subject, $message, $additional_headers);
    }
}
...
{
    return Call::invoke('mb_split',MbstringException::class,false, $pattern, $string, $limit);
}
