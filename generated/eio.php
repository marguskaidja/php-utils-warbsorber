...
use margusk\Warbsorber\Functions\Exceptions\EioException;
...
{
    return Call::invoke('eio_busy',EioException::class,false, $delay, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_chmod',EioException::class,false, $path, $mode, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_chown',EioException::class,false, $path, $uid, $gid, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_close',EioException::class,false, $fd, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_custom',EioException::class,false, $execute, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_dup2',EioException::class,false, $fd, $fd2, $pri, $callback, $data);
}
...
{
    Call::invoke('eio_event_loop',EioException::class,false);
}
...
{
    return Call::invoke('eio_fallocate',EioException::class,false, $fd, $mode, $offset, $length, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_fchmod',EioException::class,false, $fd, $mode, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_fchown',EioException::class,false, $fd, $uid, $gid, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_fdatasync',EioException::class,false, $fd, $pri, $callback, $data);
}
...
{
    if ($data !== null) {
        return Call::invoke('eio_fstat',EioException::class,false, $fd, $pri, $callback, $data);
    } else {
        return Call::invoke('eio_fstat',EioException::class,false, $fd, $pri, $callback);
    }
}
...
{
    if ($data !== null) {
        return Call::invoke('eio_fstatvfs',EioException::class,false, $fd, $pri, $callback, $data);
    } else {
        return Call::invoke('eio_fstatvfs',EioException::class,false, $fd, $pri, $callback);
    }
}
...
{
    return Call::invoke('eio_fsync',EioException::class,false, $fd, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_ftruncate',EioException::class,false, $fd, $offset, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_futime',EioException::class,false, $fd, $atime, $mtime, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_grp',EioException::class,false, $callback, $data);
}
...
{
    return Call::invoke('eio_lstat',EioException::class,false, $path, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_mkdir',EioException::class,false, $path, $mode, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_mknod',EioException::class,false, $path, $mode, $dev, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_nop',EioException::class,false, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_readahead',EioException::class,false, $fd, $offset, $length, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_readdir',EioException::class,false, $path, $flags, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_readlink',EioException::class,false, $path, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_rename',EioException::class,false, $path, $new_path, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_rmdir',EioException::class,false, $path, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_seek',EioException::class,false, $fd, $offset, $whence, $pri, $callback, $data);
}
...
{
    if ($data !== null) {
        return Call::invoke('eio_sendfile',EioException::class,false, $out_fd, $in_fd, $offset, $length, $pri, $callback, $data);
    } elseif ($callback !== null) {
        return Call::invoke('eio_sendfile',EioException::class,false, $out_fd, $in_fd, $offset, $length, $pri, $callback);
    } elseif ($pri !== null) {
        return Call::invoke('eio_sendfile',EioException::class,false, $out_fd, $in_fd, $offset, $length, $pri);
    } else {
        return Call::invoke('eio_sendfile',EioException::class,false, $out_fd, $in_fd, $offset, $length);
    }
}
...
{
    return Call::invoke('eio_stat',EioException::class,false, $path, $pri, $callback, $data);
}
...
{
    if ($data !== null) {
        return Call::invoke('eio_statvfs',EioException::class,false, $path, $pri, $callback, $data);
    } else {
        return Call::invoke('eio_statvfs',EioException::class,false, $path, $pri, $callback);
    }
}
...
{
    return Call::invoke('eio_symlink',EioException::class,false, $path, $new_path, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_sync_file_range',EioException::class,false, $fd, $offset, $nbytes, $flags, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_sync',EioException::class,false, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_syncfs',EioException::class,false, $fd, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_truncate',EioException::class,false, $path, $offset, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_unlink',EioException::class,false, $path, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_utime',EioException::class,false, $path, $atime, $mtime, $pri, $callback, $data);
}
...
{
    return Call::invoke('eio_write',EioException::class,false, $fd, $str, $length, $offset, $pri, $callback, $data);
}
