...
use margusk\Warbsorber\Functions\Exceptions\MysqlException;
...
{
    Call::invoke('mysql_close',MysqlException::class,false, $link_identifier);
}
...
{
    if ($client_flags !== 0) {
        return Call::invoke('mysql_connect',MysqlException::class,false, $server, $username, $password, $new_link, $client_flags);
    } elseif ($new_link !== false) {
        return Call::invoke('mysql_connect',MysqlException::class,false, $server, $username, $password, $new_link);
    } elseif ($password !== null) {
        return Call::invoke('mysql_connect',MysqlException::class,false, $server, $username, $password);
    } elseif ($username !== null) {
        return Call::invoke('mysql_connect',MysqlException::class,false, $server, $username);
    } elseif ($server !== null) {
        return Call::invoke('mysql_connect',MysqlException::class,false, $server);
    } else {
        return Call::invoke('mysql_connect',MysqlException::class,false);
    }
}
...
{
    Call::invoke('mysql_create_db',MysqlException::class,false, $database_name, $link_identifier);
}
...
{
    Call::invoke('mysql_data_seek',MysqlException::class,false, $result, $row_number);
}
...
{
    return Call::invoke('mysql_db_name',MysqlException::class,false, $result, $row, $field);
}
...
{
    return Call::invoke('mysql_db_query',MysqlException::class,false, $database, $query, $link_identifier);
}
...
{
    Call::invoke('mysql_drop_db',MysqlException::class,false, $database_name, $link_identifier);
}
...
{
    return Call::invoke('mysql_fetch_lengths',MysqlException::class,false, $result);
}
...
{
    return Call::invoke('mysql_field_flags',MysqlException::class,false, $result, $field_offset);
}
...
{
    return Call::invoke('mysql_field_len',MysqlException::class,false, $result, $field_offset);
}
...
{
    return Call::invoke('mysql_field_name',MysqlException::class,false, $result, $field_offset);
}
...
{
    Call::invoke('mysql_field_seek',MysqlException::class,false, $result, $field_offset);
}
...
{
    Call::invoke('mysql_free_result',MysqlException::class,false, $result);
}
...
{
    return Call::invoke('mysql_get_host_info',MysqlException::class,false, $link_identifier);
}
...
{
    return Call::invoke('mysql_get_proto_info',MysqlException::class,false, $link_identifier);
}
...
{
    return Call::invoke('mysql_get_server_info',MysqlException::class,false, $link_identifier);
}
...
{
    return Call::invoke('mysql_info',MysqlException::class,false, $link_identifier);
}
...
{
    return Call::invoke('mysql_list_dbs',MysqlException::class,false, $link_identifier);
}
...
{
    return Call::invoke('mysql_list_fields',MysqlException::class,false, $database_name, $table_name, $link_identifier);
}
...
{
    return Call::invoke('mysql_list_processes',MysqlException::class,false, $link_identifier);
}
...
{
    return Call::invoke('mysql_list_tables',MysqlException::class,false, $database, $link_identifier);
}
...
{
    return Call::invoke('mysql_num_fields',MysqlException::class,false, $result);
}
...
{
    return Call::invoke('mysql_num_rows',MysqlException::class,false, $result);
}
...
{
    return Call::invoke('mysql_query',MysqlException::class,false, $query, $link_identifier);
}
...
{
    return Call::invoke('mysql_real_escape_string',MysqlException::class,false, $unescaped_string, $link_identifier);
}
...
{
    return Call::invoke('mysql_result',MysqlException::class,false, $result, $row, $field);
}
...
{
    Call::invoke('mysql_select_db',MysqlException::class,false, $database_name, $link_identifier);
}
...
{
    Call::invoke('mysql_set_charset',MysqlException::class,false, $charset, $link_identifier);
}
...
{
    return Call::invoke('mysql_tablename',MysqlException::class,false, $result, $i);
}
...
{
    return Call::invoke('mysql_thread_id',MysqlException::class,false, $link_identifier);
}
...
{
    return Call::invoke('mysql_unbuffered_query',MysqlException::class,false, $query, $link_identifier);
}
