...
use margusk\Warbsorber\Functions\Exceptions\MiscException;
...
{
    Call::invoke('define',MiscException::class,false, $constant_name, $value, $case_insensitive);
}
...
{
    return Call::invoke('highlight_file',MiscException::class,false, $filename, $return);
}
...
{
    return Call::invoke('highlight_string',MiscException::class,false, $string, $return);
}
...
{
    return Call::invoke('hrtime',MiscException::class,false, $as_number);
}
...
{
    if ($values !== []) {
        return Call::invoke('pack',MiscException::class,false, $format, ...$values);
    } else {
        return Call::invoke('pack',MiscException::class,false, $format);
    }
}
...
{
    return Call::invoke('sapi_windows_cp_conv',MiscException::class,null, $in_codepage, $out_codepage, $subject);
}
...
{
    Call::invoke('sapi_windows_cp_set',MiscException::class,false, $codepage);
}
...
{
    Call::invoke('sapi_windows_generate_ctrl_event',MiscException::class,false, $event, $pid);
}
...
{
    Call::invoke('sapi_windows_set_ctrl_handler',MiscException::class,false, $handler, $add);
}
...
{
    if ($enable !== null) {
        Call::invoke('sapi_windows_vt100_support',MiscException::class,false, $stream, $enable);
    } else {
        Call::invoke('sapi_windows_vt100_support',MiscException::class,false, $stream);
    }
}
...
{
    return Call::invoke('time_nanosleep',MiscException::class,false, $seconds, $nanoseconds);
}
...
{
    Call::invoke('time_sleep_until',MiscException::class,false, $timestamp);
}
...
{
    return Call::invoke('unpack',MiscException::class,false, $format, $string, $offset);
}
