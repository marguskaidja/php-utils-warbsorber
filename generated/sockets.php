...
use margusk\Warbsorber\Functions\Exceptions\SocketsException;
...
{
    return Call::invoke('socket_accept',SocketsException::class,false, $socket);
}
...
{
    return Call::invoke('socket_addrinfo_bind',SocketsException::class,false, $address);
}
...
{
    return Call::invoke('socket_addrinfo_connect',SocketsException::class,false, $address);
}
...
{
    if ($hints !== []) {
        return Call::invoke('socket_addrinfo_lookup',SocketsException::class,false, $host, $service, $hints);
    } elseif ($service !== null) {
        return Call::invoke('socket_addrinfo_lookup',SocketsException::class,false, $host, $service);
    } else {
        return Call::invoke('socket_addrinfo_lookup',SocketsException::class,false, $host);
    }
}
...
{
    Call::invoke('socket_bind',SocketsException::class,false, $socket, $address, $port);
}
...
{
    if ($port !== null) {
        Call::invoke('socket_connect',SocketsException::class,false, $socket, $address, $port);
    } else {
        Call::invoke('socket_connect',SocketsException::class,false, $socket, $address);
    }
}
...
{
    return Call::invoke('socket_create_listen',SocketsException::class,false, $port, $backlog);
}
...
{
    Call::invoke('socket_create_pair',SocketsException::class,false, $domain, $type, $protocol, $pair);
}
...
{
    return Call::invoke('socket_create',SocketsException::class,false, $domain, $type, $protocol);
}
...
{
    return Call::invoke('socket_export_stream',SocketsException::class,false, $socket);
}
...
{
    return Call::invoke('socket_get_option',SocketsException::class,false, $socket, $level, $option);
}
...
{
    Call::invoke('socket_getpeername',SocketsException::class,false, $socket, $address, $port);
}
...
{
    Call::invoke('socket_getsockname',SocketsException::class,false, $socket, $address, $port);
}
...
{
    return Call::invoke('socket_import_stream',SocketsException::class,false, $stream);
}
...
{
    Call::invoke('socket_listen',SocketsException::class,false, $socket, $backlog);
}
...
{
    return Call::invoke('socket_read',SocketsException::class,false, $socket, $length, $mode);
}
...
{
    return Call::invoke('socket_send',SocketsException::class,false, $socket, $data, $length, $flags);
}
...
{
    return Call::invoke('socket_sendmsg',SocketsException::class,false, $socket, $message, $flags);
}
...
{
    if ($port !== null) {
        return Call::invoke('socket_sendto',SocketsException::class,false, $socket, $data, $length, $flags, $address, $port);
    } else {
        return Call::invoke('socket_sendto',SocketsException::class,false, $socket, $data, $length, $flags, $address);
    }
}
...
{
    Call::invoke('socket_set_block',SocketsException::class,false, $socket);
}
...
{
    Call::invoke('socket_set_nonblock',SocketsException::class,false, $socket);
}
...
{
    Call::invoke('socket_set_option',SocketsException::class,false, $socket, $level, $option, $value);
}
...
{
    Call::invoke('socket_shutdown',SocketsException::class,false, $socket, $mode);
}
...
{
    return Call::invoke('socket_wsaprotocol_info_export',SocketsException::class,false, $socket, $process_id);
}
...
{
    return Call::invoke('socket_wsaprotocol_info_import',SocketsException::class,false, $info_id);
}
...
{
    Call::invoke('socket_wsaprotocol_info_release',SocketsException::class,false, $info_id);
}
