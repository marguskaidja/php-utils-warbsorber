...
use margusk\Warbsorber\Functions\Exceptions\XdiffException;
...
{
    Call::invoke('xdiff_file_bdiff',XdiffException::class,false, $old_file, $new_file, $dest);
}
...
{
    Call::invoke('xdiff_file_bpatch',XdiffException::class,false, $file, $patch, $dest);
}
...
{
    Call::invoke('xdiff_file_diff_binary',XdiffException::class,false, $old_file, $new_file, $dest);
}
...
{
    Call::invoke('xdiff_file_diff',XdiffException::class,false, $old_file, $new_file, $dest, $context, $minimal);
}
...
{
    Call::invoke('xdiff_file_patch_binary',XdiffException::class,false, $file, $patch, $dest);
}
...
{
    Call::invoke('xdiff_file_rabdiff',XdiffException::class,false, $old_file, $new_file, $dest);
}
...
{
    return Call::invoke('xdiff_string_bpatch',XdiffException::class,false, $str, $patch);
}
...
{
    return Call::invoke('xdiff_string_patch_binary',XdiffException::class,false, $str, $patch);
}
...
{
    if ($error !== null) {
        return Call::invoke('xdiff_string_patch',XdiffException::class,false, $str, $patch, $flags, $error);
    } elseif ($flags !== null) {
        return Call::invoke('xdiff_string_patch',XdiffException::class,false, $str, $patch, $flags);
    } else {
        return Call::invoke('xdiff_string_patch',XdiffException::class,false, $str, $patch);
    }
}
